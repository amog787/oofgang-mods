...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/oneplus/android/server/openid/tsu$you;,
        Lcom/oneplus/android/server/openid/tsu$zta;
    }
.end annotation
...
.field private you:Lcom/oneplus/android/server/openid/tsu$zta;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/oneplus/android/server/openid/tsu;->wtn:Z

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lcom/oneplus/android/server/openid/tsu$zta;)V
    .locals 2
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/openid/tsu;->tsu:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, Lcom/oneplus/android/server/openid/tsu;->rtg:I

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/oneplus/android/server/openid/tsu;->ssp:Z

    iput-boolean v0, p0, Lcom/oneplus/android/server/openid/tsu;->cno:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/openid/tsu;->kth:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/openid/tsu;->bio:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/openid/tsu;->igw:Ljava/util/ArrayList;

    iput-object p1, p0, Lcom/oneplus/android/server/openid/tsu;->zta:Landroid/content/Context;

    iput-object p2, p0, Lcom/oneplus/android/server/openid/tsu;->you:Lcom/oneplus/android/server/openid/tsu$zta;

    invoke-direct {p0}, Lcom/oneplus/android/server/openid/tsu;->you()Ljava/io/File;

    iget-object p1, p0, Lcom/oneplus/android/server/openid/tsu;->tsu:Ljava/lang/Object;

    monitor-enter p1

    :try_start_0
    invoke-direct {p0}, Lcom/oneplus/android/server/openid/tsu;->ssp()V

    iget-boolean p2, p0, Lcom/oneplus/android/server/openid/tsu;->cno:Z

    if-nez p2, :cond_0

    invoke-direct {p0}, Lcom/oneplus/android/server/openid/tsu;->rtg()V
...
.method private cno(Lorg/json/JSONArray;)V
    ...
    :try_start_1
    iget v1, p0, Lcom/oneplus/android/server/openid/tsu;->rtg:I

    if-eq v1, v3, :cond_5

    iput v3, p0, Lcom/oneplus/android/server/openid/tsu;->rtg:I

    move v4, v6

    :cond_5
    sget-boolean v1, Lcom/oneplus/android/server/openid/tsu;->wtn:Z
    ...
    invoke-direct {p0, v0}, Lcom/oneplus/android/server/openid/tsu;->kth(Landroid/util/ArrayMap;)V
...
.method private kth(Landroid/util/ArrayMap;)V
    ...
    iput-boolean v12, v0, Lcom/oneplus/android/server/openid/tsu;->cno:Z
    ...
    iget-boolean v15, v0, Lcom/oneplus/android/server/openid/tsu;->cno:Z
    ...
    iput-object v14, v0, Lcom/oneplus/android/server/openid/tsu;->kth:Ljava/util/ArrayList;

    iput-object v7, v0, Lcom/oneplus/android/server/openid/tsu;->bio:Ljava/util/ArrayList;

    iput-object v2, v0, Lcom/oneplus/android/server/openid/tsu;->igw:Ljava/util/ArrayList;
    ...
    iget-object v15, v0, Lcom/oneplus/android/server/openid/tsu;->kth:Ljava/util/ArrayList;
    ...
    iget-object v14, v0, Lcom/oneplus/android/server/openid/tsu;->bio:Ljava/util/ArrayList;
    ...
    iget-object v7, v0, Lcom/oneplus/android/server/openid/tsu;->igw:Ljava/util/ArrayList;
    ...
    iput-boolean v5, v0, Lcom/oneplus/android/server/openid/tsu;->ssp:Z

    iget-object v7, v0, Lcom/oneplus/android/server/openid/tsu;->you:Lcom/oneplus/android/server/openid/tsu$zta;

    if-eqz v7, :cond_5

    iget-object v7, v0, Lcom/oneplus/android/server/openid/tsu;->you:Lcom/oneplus/android/server/openid/tsu$zta;

    invoke-interface {v7, v5}, Lcom/oneplus/android/server/openid/tsu$zta;->zta(Z)V
    ...
    :cond_6
    iget-object v1, v0, Lcom/oneplus/android/server/openid/tsu;->kth:Ljava/util/ArrayList;
    :try_end_3
    ...
    :cond_8
    iget-object v1, v0, Lcom/oneplus/android/server/openid/tsu;->bio:Ljava/util/ArrayList;
    ...
    :cond_a
    iget-object v1, v0, Lcom/oneplus/android/server/openid/tsu;->igw:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Lcom/oneplus/android/server/openid/tsu;->igw:Ljava/util/ArrayList;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/oneplus/android/server/openid/tsu;->you()Ljava/io/File;
...
.method private rtg()V
    ...
    :cond_8
    invoke-direct {p0, v5}, Lcom/oneplus/android/server/openid/tsu;->kth(Landroid/util/ArrayMap;)V
    :try_end_1
...
.method private ssp()V
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/openid/tsu;->kth:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, Lcom/oneplus/android/server/openid/tsu;->bio:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, Lcom/oneplus/android/server/openid/tsu;->igw:Ljava/util/ArrayList;
    ...
    iput-boolean v4, p0, Lcom/oneplus/android/server/openid/tsu;->ssp:Z

    iget-object v5, p0, Lcom/oneplus/android/server/openid/tsu;->you:Lcom/oneplus/android/server/openid/tsu$zta;

    if-eqz v5, :cond_1

    iget-object v5, p0, Lcom/oneplus/android/server/openid/tsu;->you:Lcom/oneplus/android/server/openid/tsu$zta;

    invoke-interface {v5, v4}, Lcom/oneplus/android/server/openid/tsu$zta;->zta(Z)V
    ...
    iput-boolean v4, p0, Lcom/oneplus/android/server/openid/tsu;->cno:Z
    ...
    iget-boolean v5, p0, Lcom/oneplus/android/server/openid/tsu;->cno:Z
    ...
    iget-object v4, p0, Lcom/oneplus/android/server/openid/tsu;->kth:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lcom/oneplus/android/server/openid/tsu;->bio:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lcom/oneplus/android/server/openid/tsu;->igw:Ljava/util/ArrayList;
...
.method static synthetic zta(Lcom/oneplus/android/server/openid/tsu;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/oneplus/android/server/openid/tsu;->cno(Lorg/json/JSONArray;)V
...
.method public sis(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/openid/tsu;->ssp:Z
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/openid/tsu;->cno:Z
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/openid/tsu;->tsu:Ljava/lang/Object;
    ...
    iget-object p2, p0, Lcom/oneplus/android/server/openid/tsu;->kth:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lcom/oneplus/android/server/openid/tsu;->bio:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lcom/oneplus/android/server/openid/tsu;->igw:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/openid/tsu;->igw:Ljava/util/ArrayList;
...
.method public tsu()V
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/openid/tsu;->zta:Landroid/content/Context;

    new-instance v2, Lcom/oneplus/android/server/openid/tsu$you;

    invoke-direct {v2, p0}, Lcom/oneplus/android/server/openid/tsu$you;-><init>(Lcom/oneplus/android/server/openid/tsu;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/openid/tsu;->sis:Lcom/oneplus/config/ConfigObserver;
