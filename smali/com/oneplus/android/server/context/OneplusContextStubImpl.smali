...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v5}, Lcom/android/server/am/vju;-><init>()V
    ...
    new-instance v5, Lcom/android/server/am/d;

    invoke-direct {v5}, Lcom/android/server/am/d;-><init>()V
    ...
    invoke-direct {v5, p1}, Lcom/android/server/am/cgv;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lcom/android/server/am/lqr;->hmo(Landroid/content/Context;)Lcom/android/server/am/lqr;
    ...
    invoke-static {v4}, Lcom/android/server/am/hmo;->sis(Landroid/content/Context;)Lcom/android/server/am/hmo;
    ...
    new-instance v4, Lcom/android/server/am/les;

    invoke-direct {v4, p1}, Lcom/android/server/am/les;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {p1}, Lcom/android/server/am/vdb;-><init>()V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/vdb;->init()V
...
.method public bootComplete()V
    ...
    invoke-static {v2}, Lcom/android/server/am/ire;->a(Landroid/content/Context;)Lcom/android/server/am/ire;

    if-eqz v1, :cond_3

    iget-object v1, p0, Lcom/oneplus/android/server/context/OneplusContextStubImpl;->you:Landroid/content/Context;

    invoke-static {v1}, Lcom/android/server/am/f;->ibl(Landroid/content/Context;)Lcom/android/server/am/f;
    ...
    invoke-static {v1}, Lcom/android/server/am/veq;->gwm(Landroid/content/Context;)Lcom/android/server/am/veq;
...
.method public systemReady()V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/am/e;->p(Landroid/content/Context;)V
    ...
    invoke-static {v2}, Lcom/android/server/am/hmo;->sis(Landroid/content/Context;)Lcom/android/server/am/hmo;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/server/am/hmo;->tsu()V
