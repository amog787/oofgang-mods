...
# direct methods
.method public constructor <init>(Lcom/android/server/ywr;Landroid/os/Looper;)V
    .locals 0
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, p0, Lcom/android/server/ywr$you;->zta:Lcom/android/server/ywr;

    invoke-virtual {v0}, Lcom/android/server/ywr;->ugm()Z
    ...
    invoke-static {}, Lcom/android/server/ywr;->you()Landroid/util/ArrayMap;
    ...
    :try_start_0
    invoke-static {}, Lcom/android/server/ywr;->bio()Z
    ...
    check-cast p1, Lcom/android/server/ywr$sis;

    if-eqz p1, :cond_5

    invoke-static {p1}, Lcom/android/server/ywr$sis;->rtg(Lcom/android/server/ywr$sis;)Z
    ...
    invoke-static {p1}, Lcom/android/server/ywr$sis;->ssp(Lcom/android/server/ywr$sis;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1}, Lcom/android/server/ywr$sis;->cno(Lcom/android/server/ywr$sis;)Z
    ...
    check-cast v2, Lcom/android/server/ywr$sis;
    ...
    :cond_7
    invoke-virtual {v2}, Lcom/android/server/ywr$sis;->kth()V
    ...
    :cond_9
    new-instance v2, Lcom/android/server/ywr$sis;

    iget-object p0, p0, Lcom/android/server/ywr$you;->zta:Lcom/android/server/ywr;

    invoke-direct {v2, p0, v0, p1}, Lcom/android/server/ywr$sis;-><init>(Lcom/android/server/ywr;ILjava/lang/String;)V
    ...
    invoke-static {p0}, Lcom/android/server/ywr;->zta(Lcom/android/server/ywr;)V
