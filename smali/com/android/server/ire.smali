...
.field private static irq:Lcom/android/server/ire; = null
...
# instance fields
.field private final bio:Lcom/android/server/ire$you;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/ire;->gwm:Z

    sget-boolean v0, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v0, Lcom/android/server/ire;->ugm:Z

    const-wide/16 v0, 0x0

    sput-wide v0, Lcom/android/server/ire;->oxb:J

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/ire;->cjf:Ljava/lang/String;

    sput-object v0, Lcom/android/server/ire;->ear:Ljava/lang/String;

    sput-object v0, Lcom/android/server/ire;->ire:Ljava/lang/String;

    sput-object v0, Lcom/android/server/ire;->hmo:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/ire;->igw:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/ire;->wtn:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, Lcom/android/server/ire;->gck:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, Lcom/android/server/ire;->dma:Landroid/util/SparseBooleanArray;

    const/4 v0, 0x0

    new-array v1, v0, [I

    iput-object v1, p0, Lcom/android/server/ire;->ywr:[I

    new-array v0, v0, [I

    iput-object v0, p0, Lcom/android/server/ire;->qbh:[I

    new-instance v0, Lcom/android/server/ire$zta;

    invoke-direct {v0, p0}, Lcom/android/server/ire$zta;-><init>(Lcom/android/server/ire;)V

    iput-object v0, p0, Lcom/android/server/ire;->bvj:Landroid/content/BroadcastReceiver;

    iput-object p1, p0, Lcom/android/server/ire;->zta:Landroid/content/Context;

    new-instance p1, Landroid/util/AtomicFile;

    new-instance v0, Ljava/io/File;

    invoke-static {}, Lcom/android/server/ire;->qbh()Ljava/io/File;
    ...
    iput-object p1, p0, Lcom/android/server/ire;->oif:Landroid/util/AtomicFile;
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/server/ire$you;-><init>(Lcom/android/server/ire;Landroid/os/Looper;)V

    iput-object p1, p0, Lcom/android/server/ire;->bio:Lcom/android/server/ire$you;
...
.method private bio()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/ire;->cno:Landroid/view/inputmethod/InputMethodManager;
...
.method private cno(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcom/android/server/ire;->cjf:Ljava/lang/String;

    if-nez v0, :cond_0

    invoke-direct {p0}, Lcom/android/server/ire;->bio()Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lcom/android/server/ire;->ear:Ljava/lang/String;

    if-nez v0, :cond_1

    invoke-direct {p0}, Lcom/android/server/ire;->igw()Ljava/lang/String;
    ...
    :cond_1
    sget-object v0, Lcom/android/server/ire;->ire:Ljava/lang/String;

    if-nez v0, :cond_2

    invoke-direct {p0}, Lcom/android/server/ire;->oif()Ljava/lang/String;
    ...
    :cond_2
    invoke-static {p1}, Lcom/android/server/ywr;->sis(Ljava/lang/String;)Z
    ...
    :cond_6
    sget-object v0, Lcom/android/server/ire;->hmo:Ljava/lang/String;
    ...
    :cond_7
    iget-object p0, p0, Lcom/android/server/ire;->tsu:Ljava/util/List;
...
.method private gwm()V
    ...
    iget-object v0, p0, Lcom/android/server/ire;->ssp:Landroid/appwidget/AppWidgetManager;
    ...
    iput-object v0, p0, Lcom/android/server/ire;->tsu:Ljava/util/List;
...
.method private hmo()V
    ...
    sget-wide v2, Lcom/android/server/ire;->oxb:J
    ...
    :cond_1
    sget-boolean v0, Lcom/android/server/ire;->ugm:Z
    ...
    sput-object v2, Lcom/android/server/ire;->cjf:Ljava/lang/String;
    ...
    sput-object v2, Lcom/android/server/ire;->ear:Ljava/lang/String;
    ...
    sput-object v2, Lcom/android/server/ire;->ire:Ljava/lang/String;
    ...
    :cond_5
    sput-object v1, Lcom/android/server/ire;->hmo:Ljava/lang/String;

    iget-object v1, p0, Lcom/android/server/ire;->rtg:Landroid/app/ActivityManager;
    ...
    sput-object v2, Lcom/android/server/ire;->hmo:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_8
    invoke-direct {p0}, Lcom/android/server/ire;->gwm()V
...
.method private igw()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/ire;->you:Landroid/content/pm/PackageManager;
...
.method private irq()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/ire;->igw:Landroid/util/ArrayMap;

    iget-object v1, p0, Lcom/android/server/ire;->gck:Landroid/util/SparseBooleanArray;

    const/4 v2, 0x0

    invoke-static {v2, v0, v1}, Lcom/android/server/ire;->ssp(Landroid/util/ArrayMap;Landroid/util/ArrayMap;Landroid/util/SparseBooleanArray;)[I

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/ire;->ywr:[I

    iget-object v0, p0, Lcom/android/server/ire;->wtn:Landroid/util/ArrayMap;

    iget-object v1, p0, Lcom/android/server/ire;->dma:Landroid/util/SparseBooleanArray;
...
.method private les(ILjava/lang/String;I)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/ire;->vdb(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/server/ire;->sis:Landroid/app/AppOpsManager;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/server/ire;->sis:Landroid/app/AppOpsManager;
...
.method private lqr(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v2, p0, Lcom/android/server/ire;->zta:Landroid/content/Context;
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/ire;->tsu(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/ire;->sis(Ljava/lang/String;)Z
...
.method private oif()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/ire;->kth:Landroid/app/WallpaperManager;
    ...
    iget-object p0, p0, Lcom/android/server/ire;->kth:Landroid/app/WallpaperManager;
...
.method private rtg(Ljava/lang/String;)V
    ...
    sget-object p0, Lcom/android/server/ire;->zgw:Lcom/android/server/OpPowerControllerService;
...
.method private vju()V
    ...
    iget-object p0, p0, Lcom/android/server/ire;->zta:Landroid/content/Context;
...
.method public static wtn(Landroid/content/Context;)Lcom/android/server/ire;
    .locals 1

    sget-object v0, Lcom/android/server/ire;->irq:Lcom/android/server/ire;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/ire;

    invoke-direct {v0, p0}, Lcom/android/server/ire;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/android/server/ire;->irq:Lcom/android/server/ire;

    :cond_0
    sget-object p0, Lcom/android/server/ire;->irq:Lcom/android/server/ire;

    return-object p0
.end method

.method static synthetic you(Lcom/android/server/ire;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/ire;->irq()V
...
.method public bud(Ljava/lang/String;I)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/android/server/ire;->veq(Ljava/lang/String;)Z

    move-result p2

    invoke-virtual {p0, p1}, Lcom/android/server/ire;->cgv(Ljava/lang/String;)Z

    move-result v0

    or-int/2addr p2, v0

    invoke-direct {p0, p1}, Lcom/android/server/ire;->rtg(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/ire;->sis(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/ire;->tsu(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0}, Lcom/android/server/ire;->vdw()V

    invoke-direct {p0}, Lcom/android/server/ire;->vju()V

    :cond_3
    sget-boolean p0, Lcom/android/server/ire;->ugm:Z
...
.method public bvj()Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/ire;->wtn:Landroid/util/ArrayMap;
...
.method public cjf(Ljava/lang/String;)Z
    ...
    sget-boolean v0, Lcom/android/server/ire;->gwm:Z
...
.method public dma()[I
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/ire;->ywr:[I
...
.method ear()V
    ...
    sget-boolean v1, Lcom/android/server/ire;->fto:Z
    ...
    :try_start_1
    iget-object v5, p0, Lcom/android/server/ire;->you:Landroid/content/pm/PackageManager;
    ...
    iget-object v6, p0, Lcom/android/server/ire;->wtn:Landroid/util/ArrayMap;
...
.method fto()V
    ...
    sget-boolean v1, Lcom/android/server/ire;->ugm:Z
    ...
    iget-object v3, p0, Lcom/android/server/ire;->oif:Landroid/util/AtomicFile;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/server/ire;->igw:Landroid/util/ArrayMap;

    invoke-virtual {v1}, Landroid/util/ArrayMap;->clear()V

    :try_start_0
    iget-object v1, p0, Lcom/android/server/ire;->oif:Landroid/util/AtomicFile;
    ...
    sput-boolean v3, Lcom/android/server/ire;->fto:Z
    :try_end_0
    ...
    invoke-direct {p0, v3}, Lcom/android/server/ire;->lqr(Lorg/xmlpull/v1/XmlPullParser;)V
    :try_end_1
...
.method public gck()[I
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/ire;->qbh:[I
...
.method public getForcedOptApps()Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/ire;->igw:Landroid/util/ArrayMap;
...
.method ibl()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/ire;->qeg(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-object v0, p0, Lcom/android/server/ire;->oif:Landroid/util/AtomicFile;
    ...
    iget-object p0, p0, Lcom/android/server/ire;->oif:Landroid/util/AtomicFile;
...
.method public ire()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/ire;->zta:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/server/ire;->you:Landroid/content/pm/PackageManager;
    ...
    iput-object v0, p0, Lcom/android/server/ire;->sis:Landroid/app/AppOpsManager;
    ...
    iput-object v0, p0, Lcom/android/server/ire;->rtg:Landroid/app/ActivityManager;
    ...
    iput-object v0, p0, Lcom/android/server/ire;->cno:Landroid/view/inputmethod/InputMethodManager;
    ...
    iput-object v0, p0, Lcom/android/server/ire;->ssp:Landroid/appwidget/AppWidgetManager;
    ...
    iput-object v0, p0, Lcom/android/server/ire;->kth:Landroid/app/WallpaperManager;

    invoke-virtual {p0}, Lcom/android/server/ire;->fto()V

    invoke-virtual {p0}, Lcom/android/server/ire;->ear()V
    ...
    iget-object v1, p0, Lcom/android/server/ire;->zta:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/ire;->bvj:Landroid/content/BroadcastReceiver;
    ...
    sput-object v0, Lcom/android/server/ire;->zgw:Lcom/android/server/OpPowerControllerService;

    const/4 v0, 0x1

    sput-boolean v0, Lcom/android/server/ire;->lqr:Z
...
.method public isDeepClean(Ljava/lang/String;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/ire;->hmo()V

    invoke-direct {p0, p1}, Lcom/android/server/ire;->cno(Ljava/lang/String;)Z
...
.method public isInitial()Z
    ...
    sget-boolean p0, Lcom/android/server/ire;->lqr:Z
...
.method public kth(Ljava/io/PrintWriter;)V
    ...
    sget-object v1, Lcom/android/server/ire;->cjf:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/ire;->ear:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/ire;->ire:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/ire;->hmo:Ljava/lang/String;
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/server/ire;->tsu:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/android/server/ire;->tsu:Ljava/util/List;
    ...
    :cond_0
    invoke-static {p1}, Lcom/android/server/ywr;->zta(Ljava/io/PrintWriter;)V
...
.method qeg(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/server/ire;->igw:Landroid/util/ArrayMap;
    ...
    iget-object v6, p0, Lcom/android/server/ire;->igw:Landroid/util/ArrayMap;
    ...
    :cond_0
    :goto_1
    iget-object v3, p0, Lcom/android/server/ire;->wtn:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, Lcom/android/server/ire;->wtn:Landroid/util/ArrayMap;
...
.method public setPowerSaveWhitelistAppIds([I[I)V
    ...
    sget-boolean p2, Lcom/android/server/ire;->ugm:Z
    ...
    :try_start_0
    iput-object p1, p0, Lcom/android/server/ire;->qbh:[I
...
.method public shellCommand(Ljava/io/PrintWriter;)Z
    ...
    new-instance v3, Lcom/android/server/ire$sis;

    iget-object v4, p0, Lcom/android/server/ire;->igw:Landroid/util/ArrayMap;

    invoke-direct {v3, p0, v4}, Lcom/android/server/ire$sis;-><init>(Lcom/android/server/ire;Ljava/util/Map;)V
...
.method public sis(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/ire;->you:Landroid/content/pm/PackageManager;
    ...
    invoke-direct {p0, v2}, Lcom/android/server/ire;->zgw(Landroid/content/pm/ApplicationInfo;)Z

    move-result v3

    if-nez v3, :cond_4

    invoke-direct {p0, v2}, Lcom/android/server/ire;->obl(Landroid/content/pm/ApplicationInfo;)Z
    ...
    sget-boolean v4, Lcom/android/server/ire;->ugm:Z
    ...
    invoke-direct {p0, v1, p1, v4}, Lcom/android/server/ire;->les(ILjava/lang/String;I)V
...
.method public tsu(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1, p1, v0}, Lcom/android/server/ire;->les(ILjava/lang/String;I)V
    :try_end_2
...
.method vdw()V
    ...
    iget-object v0, p0, Lcom/android/server/ire;->bio:Lcom/android/server/ire$you;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, Lcom/android/server/ire;->bio:Lcom/android/server/ire$you;
...
.method public veq(Ljava/lang/String;)Z
    ...
    sget-boolean v3, Lcom/android/server/ire;->ugm:Z
    ...
    invoke-direct {p0, v0, p1, v2}, Lcom/android/server/ire;->les(ILjava/lang/String;I)V
