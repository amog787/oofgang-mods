...
# instance fields
.field private mActionListener:Lcom/android/server/cgv/zta$zta;

.field private final mActionProviderImpl:Lcom/android/server/cgv/zta;
...
.field private mOpVCAction:Lcom/android/server/cgv/you;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/inputmethod/OpVerificationCodeController;->mActionProviderImpl:Lcom/android/server/cgv/zta;
...
.method static synthetic access$1102(Lcom/android/server/inputmethod/OpVerificationCodeController;Lcom/android/server/cgv/zta$zta;)Lcom/android/server/cgv/zta$zta;
    .locals 0

    iput-object p1, p0, Lcom/android/server/inputmethod/OpVerificationCodeController;->mActionListener:Lcom/android/server/cgv/zta$zta;
...
.method static synthetic access$500(Lcom/android/server/inputmethod/OpVerificationCodeController;)Lcom/android/server/cgv/you;
    .locals 0

    iget-object p0, p0, Lcom/android/server/inputmethod/OpVerificationCodeController;->mOpVCAction:Lcom/android/server/cgv/you;
...
.method private initActionIfPossible()V
    ...
    iget-object v0, p0, Lcom/android/server/inputmethod/OpVerificationCodeController;->mOpVCAction:Lcom/android/server/cgv/you;
    ...
    :cond_2
    new-instance v0, Lcom/android/server/cgv/you;

    iget-object v1, p0, Lcom/android/server/inputmethod/OpVerificationCodeController;->mContext:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/inputmethod/OpVerificationCodeController;->mActionProviderImpl:Lcom/android/server/cgv/zta;

    invoke-direct {v0, v1, v2}, Lcom/android/server/cgv/you;-><init>(Landroid/content/Context;Lcom/android/server/cgv/zta;)V

    iput-object v0, p0, Lcom/android/server/inputmethod/OpVerificationCodeController;->mOpVCAction:Lcom/android/server/cgv/you;
...
.method public notifyIMELayoutChanged(ZLcom/android/server/wm/DisplayFrames;)V
    ...
    iget-object p0, p0, Lcom/android/server/inputmethod/OpVerificationCodeController;->mActionListener:Lcom/android/server/cgv/zta$zta;

    if-eqz p0, :cond_3

    invoke-interface {p0, p1}, Lcom/android/server/cgv/zta$zta;->zta(I)V
