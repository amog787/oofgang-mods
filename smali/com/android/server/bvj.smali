.class public final Lcom/android/server/bvj;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/bvj;->wtn:Z
    ...
    sput-object v0, Lcom/android/server/bvj;->oif:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/bvj;->zta:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput v0, p0, Lcom/android/server/bvj;->rtg:I

    iput v0, p0, Lcom/android/server/bvj;->ssp:I

    iput-boolean v0, p0, Lcom/android/server/bvj;->cno:Z

    new-instance v1, Lcom/android/server/bvj$zta;

    invoke-direct {v1, p0}, Lcom/android/server/bvj$zta;-><init>(Lcom/android/server/bvj;)V

    iput-object v1, p0, Lcom/android/server/bvj;->bio:Landroid/content/BroadcastReceiver;
...
.method static synthetic bio()[Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/server/bvj;->oif:[Ljava/lang/String;
...
.method private bvj()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/bvj;->kth:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/bvj;->bio:Landroid/content/BroadcastReceiver;
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/server/bvj;->tsu:Landroid/content/pm/PackageInstaller$Session;
    ...
    iget-boolean p0, p0, Lcom/android/server/bvj;->cno:Z
...
.method static synthetic cno(Lcom/android/server/bvj;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/bvj;->bvj()V
...
.method private dma(Ljava/lang/String;)V
    ...
    iget p1, p0, Lcom/android/server/bvj;->ssp:I

    if-nez p1, :cond_3

    iget-object p1, p0, Lcom/android/server/bvj;->kth:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/bvj;->you:Landroid/content/pm/PackageManager;

    invoke-virtual {p1}, Landroid/content/pm/PackageManager;->getPackageInstaller()Landroid/content/pm/PackageInstaller;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/bvj;->sis:Landroid/content/pm/PackageInstaller;
    ...
    sget-boolean v4, Lcom/android/server/bvj;->gck:Z
    ...
    :cond_1
    invoke-direct {p0, v3}, Lcom/android/server/bvj;->gck(Ljava/io/File;)V
...
.method private gck(Ljava/io/File;)V
    ...
    iget-object v1, p0, Lcom/android/server/bvj;->kth:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/android/server/bvj;->you:Landroid/content/pm/PackageManager;
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/server/bvj;->you:Landroid/content/pm/PackageManager;
    ...
    :cond_2
    invoke-direct {p0, v2}, Lcom/android/server/bvj;->oif(Landroid/content/pm/PackageInfo;)Z
    ...
    iget-object v2, p0, Lcom/android/server/bvj;->zta:Ljava/util/HashMap;
    ...
    sget-boolean p0, Lcom/android/server/bvj;->wtn:Z
    ...
    :cond_5
    sget-boolean v2, Lcom/android/server/bvj;->wtn:Z
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/bvj;->qbh()V

    iget v2, p0, Lcom/android/server/bvj;->ssp:I

    const/4 v4, 0x1

    add-int/2addr v2, v4

    iput v2, p0, Lcom/android/server/bvj;->ssp:I

    iget-object v5, p0, Lcom/android/server/bvj;->zta:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcom/android/server/bvj;->sis:Landroid/content/pm/PackageInstaller;
    ...
    iput-object v4, p0, Lcom/android/server/bvj;->tsu:Landroid/content/pm/PackageInstaller$Session;
    ...
    :try_start_1
    iget-object v5, p0, Lcom/android/server/bvj;->tsu:Landroid/content/pm/PackageInstaller$Session;
    ...
    :cond_7
    iget-object p1, p0, Lcom/android/server/bvj;->tsu:Landroid/content/pm/PackageInstaller$Session;
    ...
    invoke-direct {p0, v2, v1}, Lcom/android/server/bvj;->wtn(ILjava/lang/String;)Landroid/content/IntentSender;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroid/content/pm/PackageInstaller$Session;->commit(Landroid/content/IntentSender;)V

    iget-object p0, p0, Lcom/android/server/bvj;->tsu:Landroid/content/pm/PackageInstaller$Session;
...
.method private ibl()V
    ...
    sget-boolean v1, Lcom/android/server/bvj;->wtn:Z
    ...
    :goto_2
    sget-boolean v4, Lcom/android/server/bvj;->wtn:Z
...
.method static synthetic igw(Lcom/android/server/bvj;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/bvj;->dma(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic kth(Lcom/android/server/bvj;)V
    .locals 0
...
.method private oif(Landroid/content/pm/PackageInfo;)Z
    ...
    iget-object v3, p0, Lcom/android/server/bvj;->you:Landroid/content/pm/PackageManager;
    ...
    iget-object p0, p0, Lcom/android/server/bvj;->you:Landroid/content/pm/PackageManager;
    ...
    :cond_0
    sget-boolean v3, Lcom/android/server/bvj;->gck:Z
...
.method private qbh()V
    ...
    iget-object v2, p0, Lcom/android/server/bvj;->kth:Landroid/content/Context;

    iget-object v3, p0, Lcom/android/server/bvj;->bio:Landroid/content/BroadcastReceiver;
...
.method static synthetic rtg(Lcom/android/server/bvj;)Ljava/util/HashMap;
    .locals 0

    iget-object p0, p0, Lcom/android/server/bvj;->zta:Ljava/util/HashMap;

    return-object p0
.end method

.method static synthetic sis(Lcom/android/server/bvj;)I
    .locals 0

    iget p0, p0, Lcom/android/server/bvj;->ssp:I
...
.method static synthetic tsu(Lcom/android/server/bvj;)I
    ...
    iget v0, p0, Lcom/android/server/bvj;->ssp:I

    add-int/lit8 v1, v0, -0x1

    iput v1, p0, Lcom/android/server/bvj;->ssp:I
...
.method private wtn(ILjava/lang/String;)Landroid/content/IntentSender;
    ...
    iget-object p0, p0, Lcom/android/server/bvj;->kth:Landroid/content/Context;
...
.method static synthetic you()Z
    ...
    sget-boolean v0, Lcom/android/server/bvj;->wtn:Z
...
.method public ywr(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/bvj;->kth:Landroid/content/Context;
    ...
    invoke-direct {v0, p0, p2}, Lcom/android/server/bvj$you;-><init>(Lcom/android/server/bvj;Ljava/lang/String;)V
