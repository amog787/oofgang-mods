...
.field private sis:Lcom/android/server/oif$you;
...
.field private final tsu:Lcom/android/server/oif$sis;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/oif;->dma:Z

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/oif;->oif:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/oif;->bvj:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/oif;->ibl:Ljava/util/List;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/android/server/oif;->gwm:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;

    new-instance v0, Lcom/android/server/oif$sis;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/oif$sis;-><init>(Lcom/android/server/oif;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/oif;->tsu:Lcom/android/server/oif$sis;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/oif;->ssp:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/oif;->cno:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/oif;->kth:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/oif;->bio:Landroid/util/ArrayMap;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/android/server/oif;->igw:Ljava/lang/Object;
...
.method static synthetic sis(Lcom/android/server/oif;)Lcom/android/server/AlarmManagerService$AmsInner;
    .locals 0

    iget-object p0, p0, Lcom/android/server/oif;->zta:Lcom/android/server/AlarmManagerService$AmsInner;
...
.method private ssp(Lcom/android/server/AlarmManagerService$Alarm;JJ)Z
    ...
    sget-object v0, Lcom/android/server/oif;->gwm:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/oif;->oif:Landroid/util/ArrayMap;
    ...
    iget-object v1, p0, Lcom/android/server/oif;->cno:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/oif;->rtg(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_5

    invoke-virtual {p0, p2, p3}, Lcom/android/server/oif;->cno(J)J
    ...
    invoke-direct {p0}, Lcom/android/server/oif;->igw()J
    ...
    iget-object p2, p0, Lcom/android/server/oif;->zta:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    sget-boolean p2, Lcom/android/server/oif;->gck:Z
    ...
    :cond_3
    iget-object p2, p0, Lcom/android/server/oif;->cno:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lcom/android/server/oif;->igw:Ljava/lang/Object;

    monitor-enter p2

    :try_start_1
    iget-object p3, p0, Lcom/android/server/oif;->ssp:Landroid/util/ArrayMap;
    ...
    iget-object p1, p0, Lcom/android/server/oif;->bio:Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/oif;->bio:Landroid/util/ArrayMap;
    ...
    :cond_5
    iget-object p2, p0, Lcom/android/server/oif;->bio:Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/oif;->cno:Ljava/util/ArrayList;
...
.method static synthetic tsu()Z
    ...
    sget-boolean v0, Lcom/android/server/oif;->dma:Z

    return v0
.end method

.method static synthetic you(Lcom/android/server/oif;)Lcom/android/server/oif$you;
    .locals 0

    iget-object p0, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;
...
.method private ywr(Ljava/lang/String;ZI)V
    ...
    sget-object p2, Lcom/android/server/oif;->gwm:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    sget-object p0, Lcom/android/server/oif;->oif:Landroid/util/ArrayMap;
    ...
    sget-object p0, Lcom/android/server/oif;->bvj:Landroid/util/ArrayMap;
    ...
    iget-object p3, p0, Lcom/android/server/oif;->zta:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    sget-object p0, Lcom/android/server/oif;->gwm:Ljava/lang/Object;

    monitor-enter p0

    :try_start_1
    sget-object p2, Lcom/android/server/oif;->oif:Landroid/util/ArrayMap;

    invoke-virtual {p2, p1}, Landroid/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object p2, Lcom/android/server/oif;->bvj:Landroid/util/ArrayMap;
...
.method static synthetic zta(Lcom/android/server/oif;)Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/android/server/oif;->you:Landroid/content/Context;
...
.method public bio(Z)Z
    ...
    sget-boolean p0, Lcom/android/server/oif;->dma:Z

    sput-boolean p1, Lcom/android/server/oif;->dma:Z
...
.method cno(J)J
    ...
    :goto_0
    iget-wide p0, p0, Lcom/android/server/oif;->rtg:J
...
.method public deliverDelayAlarm(Landroid/os/Message;)V
    ...
    iget-object v3, p0, Lcom/android/server/oif;->igw:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    iget-object v6, p0, Lcom/android/server/oif;->ssp:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, Lcom/android/server/oif;->zta:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v0, p0, Lcom/android/server/oif;->igw:Ljava/lang/Object;
    ...
    iget-object v3, p0, Lcom/android/server/oif;->ssp:Landroid/util/ArrayMap;
    ...
    :goto_2
    iget-object v1, p0, Lcom/android/server/oif;->bio:Landroid/util/ArrayMap;
    ...
    iget-object v5, p0, Lcom/android/server/oif;->cno:Ljava/util/ArrayList;

    invoke-virtual {v5, v3}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    iget-object v5, p0, Lcom/android/server/oif;->kth:Landroid/util/ArrayMap;
...
.method public dma(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;

    invoke-virtual {p1, v0}, Lcom/android/server/oif$you;->gck(Z)Z

    iget-object p1, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;

    invoke-virtual {p1, v0}, Lcom/android/server/oif$you;->sis(Z)Z
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/oif$you;->gck(Z)Z

    iget-object p1, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;

    invoke-virtual {p1, v3}, Lcom/android/server/oif$you;->sis(Z)Z
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Lcom/android/server/oif$you;->vdb(J)J
...
.method public gck(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/oif$you;->oif(Lcom/android/server/AlarmManagerService$Alarm;)Z
...
.method public initAlarmAlignment(II)V
    ...
    iget-object p1, p0, Lcom/android/server/oif;->you:Landroid/content/Context;
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/oif$you;->wtn(Z)Z

    iget-object p1, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;

    invoke-virtual {p1}, Lcom/android/server/oif$you;->ywr()V

    iget-object p1, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;

    invoke-virtual {p1}, Lcom/android/server/oif$you;->qbh()V

    iget-object p1, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;

    invoke-virtual {p1}, Lcom/android/server/oif$you;->bvj()V

    iget-object p0, p0, Lcom/android/server/oif;->tsu:Lcom/android/server/oif$sis;
...
.method public initInstance(Lcom/android/server/AlarmManagerService$AmsInner;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/oif;->zta:Lcom/android/server/AlarmManagerService$AmsInner;

    iput-object p2, p0, Lcom/android/server/oif;->you:Landroid/content/Context;
    ...
    iget-object p2, p0, Lcom/android/server/oif;->you:Landroid/content/Context;

    iget-object v0, p0, Lcom/android/server/oif;->zta:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v1, p0, Lcom/android/server/oif;->tsu:Lcom/android/server/oif$sis;

    invoke-direct {p1, p0, p2, v0, v1}, Lcom/android/server/oif$you;-><init>(Lcom/android/server/oif;Landroid/content/Context;Landroid/os/Handler;Landroid/os/Handler;)V

    iput-object p1, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;
...
.method public kth(Z)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/oif$you;->wtn(Z)Z
...
.method public rtg(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/oif;->wtn(Ljava/lang/String;)Z
...
.method public setAlarmAlignment(Lcom/android/server/AlarmManagerService$Alarm;Lcom/android/server/AlarmManagerService$AlarmAlignmentReason;JJ)Z
    ...
    iget-object v0, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;
    ...
    sget-object v2, Lcom/android/server/oif$zta;->zta:[I
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/oif;->ssp(Lcom/android/server/AlarmManagerService$Alarm;JJ)Z
    ...
    :cond_7
    iget-object p2, p0, Lcom/android/server/oif;->sis:Lcom/android/server/oif$you;

    invoke-virtual {p2, p1, v1}, Lcom/android/server/oif$you;->cno(Lcom/android/server/AlarmManagerService$Alarm;Z)J
    ...
    :cond_8
    iget-object v1, p0, Lcom/android/server/oif;->zta:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/oif$you;->cno(Lcom/android/server/AlarmManagerService$Alarm;Z)J
...
.method public setBlackAlarm(Ljava/util/List;)V
    ...
    sget-object p0, Lcom/android/server/oif;->ibl:Ljava/util/List;
    ...
    sget-object p1, Lcom/android/server/oif;->ibl:Ljava/util/List;
...
.method public setBlockAlarmUid(Ljava/lang/String;ZI)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/oif;->ywr(Ljava/lang/String;ZI)V
...
.method public shellCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    sget-boolean v2, Lcom/android/server/oif;->gck:Z
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/oif$you;->ugm(J)V
    :try_end_0
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/oif$you;->kth(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/oif$you;->gwm(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/oif$you;->gwm(Z)V
