.class Lcom/android/server/cjf$kth;
...
# direct methods
.method public constructor <init>(Lcom/android/server/cjf;Landroid/os/Handler;Landroid/content/ContentResolver;)V
    .locals 0

    iput-object p1, p0, Lcom/android/server/cjf$kth;->you:Lcom/android/server/cjf;

    invoke-direct {p0, p2}, Landroid/database/ContentObserver;-><init>(Landroid/os/Handler;)V

    iput-object p3, p0, Lcom/android/server/cjf$kth;->zta:Landroid/content/ContentResolver;
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    iget-object p0, p0, Lcom/android/server/cjf$kth;->zta:Landroid/content/ContentResolver;
    ...
    invoke-static {p2}, Lcom/android/server/cjf;->oxb(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2, p0}, Lcom/android/server/cjf;->hmo(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/android/server/cjf$kth;->zta:Landroid/content/ContentResolver;

    invoke-static {v4, p1, v2}, Landroid/provider/Settings$System;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z

    iget-object p1, p0, Lcom/android/server/cjf$kth;->you:Lcom/android/server/cjf;
    ...
    invoke-static {p1, v0}, Lcom/android/server/cjf;->oif(Lcom/android/server/cjf;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/cjf$kth;->you:Lcom/android/server/cjf;

    invoke-static {p0}, Lcom/android/server/cjf;->qbh(Lcom/android/server/cjf;)Ljava/lang/String;
