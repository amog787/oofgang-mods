...
.method public zta(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-virtual {p1, p4}, Lcom/android/server/am/bio;->ssp(I)Lcom/android/server/am/g;

    move-result-object p1

    if-eqz p1, :cond_7

    iget-object v2, p1, Lcom/android/server/am/g;->sis:Ljava/lang/String;
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/am/g;->zta(I)V

    invoke-virtual {p1, v0}, Lcom/android/server/am/g;->zta(I)V

    invoke-virtual {p1}, Lcom/android/server/am/g;->tsu()I
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/am/bio;->ssp(I)Lcom/android/server/am/g;
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/am/g;->qbh(I)V

    invoke-virtual {p1, v0}, Lcom/android/server/am/g;->qbh(I)V
