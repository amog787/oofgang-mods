...
.field private kth:Lcom/android/server/am/les$sis;

.field private rtg:Lcom/oneplus/config/ConfigObserver;

.field private sis:Ljava/lang/String;

.field private ssp:Lcom/android/server/am/les$you;
...
.method static constructor <clinit>()V
    ...
    :cond_1
    sput-boolean v1, Lcom/android/server/am/les;->bvj:Z

    sget-boolean v0, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v0, Lcom/android/server/am/les;->ibl:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/les;->cno:Z

    const-wide/32 v1, 0x6ddd00

    iput-wide v1, p0, Lcom/android/server/am/les;->bio:J

    iput-boolean v0, p0, Lcom/android/server/am/les;->igw:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lcom/android/server/am/les;->wtn:J
    ...
    iput-object v1, p0, Lcom/android/server/am/les;->gck:Ljava/util/regex/Pattern;
    ...
    iput-object v1, p0, Lcom/android/server/am/les;->dma:Ljava/util/regex/Pattern;
    ...
    iput-object v1, p0, Lcom/android/server/am/les;->ywr:Ljava/util/regex/Pattern;

    iput-object p1, p0, Lcom/android/server/am/les;->zta:Landroid/content/Context;

    new-instance p1, Lcom/android/server/am/les$sis;
    ...
    invoke-direct {p1, p0, v1}, Lcom/android/server/am/les$sis;-><init>(Lcom/android/server/am/les;Landroid/os/Looper;)V

    iput-object p1, p0, Lcom/android/server/am/les;->kth:Lcom/android/server/am/les$sis;

    invoke-virtual {p1, v0}, Landroid/os/Handler;->obtainMessage(I)Landroid/os/Message;

    move-result-object p1

    iget-object p0, p0, Lcom/android/server/am/les;->kth:Lcom/android/server/am/les$sis;
...
.method static synthetic bio(Lcom/android/server/am/les;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/les;->igw:Z

    return p0
.end method

.method static synthetic cno(Lcom/android/server/am/les;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/les;->cno:Z
...
.method private dma(Ljava/lang/StringBuilder;)V
    ...
    iget-boolean v8, v1, Lcom/android/server/am/les;->igw:Z
    ...
    iget-object v10, v1, Lcom/android/server/am/les;->gck:Ljava/util/regex/Pattern;
    ...
    sget-boolean v11, Lcom/android/server/am/les;->ibl:Z
    ...
    iget-object v10, v1, Lcom/android/server/am/les;->dma:Ljava/util/regex/Pattern;
    ...
    iget-object v10, v1, Lcom/android/server/am/les;->ywr:Ljava/util/regex/Pattern;
    ...
    sget-boolean v10, Lcom/android/server/am/les;->ibl:Z
    ...
    :cond_6
    sget-boolean v0, Lcom/android/server/am/les;->ibl:Z
    ...
    iget-object v0, v1, Lcom/android/server/am/les;->you:Landroid/os/DropBoxManager;

    if-eqz v0, :cond_8

    iget-object v1, v1, Lcom/android/server/am/les;->sis:Ljava/lang/String;
...
.method static synthetic igw(Lcom/android/server/am/les;)J
    .locals 2

    iget-wide v0, p0, Lcom/android/server/am/les;->bio:J

    return-wide v0
.end method

.method static synthetic kth(Lcom/android/server/am/les;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/am/les;->cno:Z

    return p1
.end method

.method static synthetic rtg(Lcom/android/server/am/les;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/les;->zta:Landroid/content/Context;

    return-object p0
.end method

.method static synthetic sis(Lcom/android/server/am/les;)Lcom/oneplus/config/ConfigObserver;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/les;->rtg:Lcom/oneplus/config/ConfigObserver;

    return-object p0
.end method

.method static synthetic ssp(Lcom/android/server/am/les;Ljava/lang/StringBuilder;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/les;->dma(Ljava/lang/StringBuilder;)V

    return-void
.end method

.method static synthetic tsu(Lcom/android/server/am/les;Lcom/oneplus/config/ConfigObserver;)Lcom/oneplus/config/ConfigObserver;
    .locals 0

    iput-object p1, p0, Lcom/android/server/am/les;->rtg:Lcom/oneplus/config/ConfigObserver;

    return-object p1
.end method

.method static synthetic wtn(Lcom/android/server/am/les;J)J
    .locals 0

    iput-wide p1, p0, Lcom/android/server/am/les;->bio:J

    return-wide p1
.end method

.method static synthetic you(Lcom/android/server/am/les;Lcom/android/server/am/les$you;)Lcom/android/server/am/les$you;
    .locals 0

    iput-object p1, p0, Lcom/android/server/am/les;->ssp:Lcom/android/server/am/les$you;

    return-object p1
.end method

.method static synthetic zta(Lcom/android/server/am/les;)Lcom/android/server/am/les$you;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/les;->ssp:Lcom/android/server/am/les$you;
...
.method public collectBatteryStats(Lcom/android/internal/os/BatteryStatsImpl;IIIZ)V
    ...
    :cond_0
    sget-boolean p2, Lcom/android/server/am/les;->ibl:Z
    ...
    iget-boolean p4, p0, Lcom/android/server/am/les;->cno:Z

    if-eqz p4, :cond_2

    iget-wide p4, p0, Lcom/android/server/am/les;->wtn:J

    cmp-long p2, p2, p4

    if-eqz p2, :cond_2

    iget-object p2, p0, Lcom/android/server/am/les;->zta:Landroid/content/Context;
    ...
    invoke-virtual {p0, p3, p2}, Lcom/android/server/am/les;->gck(Ljava/lang/String;Landroid/os/DropBoxManager;)V

    invoke-virtual {p1}, Lcom/android/internal/os/BatteryStatsImpl;->getResetTime()J

    move-result-wide p1

    iput-wide p1, p0, Lcom/android/server/am/les;->wtn:J
...
.method public gck(Ljava/lang/String;Landroid/os/DropBoxManager;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/les;->you:Landroid/os/DropBoxManager;

    if-nez v0, :cond_0

    iput-object p2, p0, Lcom/android/server/am/les;->you:Landroid/os/DropBoxManager;

    :cond_0
    iget-object p2, p0, Lcom/android/server/am/les;->sis:Ljava/lang/String;

    if-nez p2, :cond_1

    iput-object p1, p0, Lcom/android/server/am/les;->sis:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/server/am/les;->kth:Lcom/android/server/am/les$sis;
