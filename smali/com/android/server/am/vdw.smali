...
.method public static sis()Lcom/android/server/am/vdw;
    .locals 1

    invoke-static {}, Lcom/android/server/am/vdw$you;->zta()Lcom/android/server/am/vdw;
...
.method public rtg(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/BroadcastRecord;I)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/am/vdw;->tsu(Ljava/lang/String;Ljava/util/List;)V

    const-string p1, "highUsedList"

    invoke-direct {p0, p1, v2}, Lcom/android/server/am/vdw;->tsu(Ljava/lang/String;Ljava/util/List;)V

    const-string p1, "systemList"

    invoke-direct {p0, p1, v3}, Lcom/android/server/am/vdw;->tsu(Ljava/lang/String;Ljava/util/List;)V

    const-string p1, "otherList"

    invoke-direct {p0, p1, v4}, Lcom/android/server/am/vdw;->tsu(Ljava/lang/String;Ljava/util/List;)V
...
.method public zta(Ljava/util/List;Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/vdw;->you(Ljava/util/List;Landroid/content/Intent;)Ljava/util/List;
