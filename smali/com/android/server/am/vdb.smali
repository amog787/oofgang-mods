...
.method public adjustIfAppNotExist(Lcom/android/server/am/BroadcastRecord;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/obl;->zta(Lcom/android/server/am/BroadcastRecord;)V
...
.method public adjustReceiverListForSMS(Ljava/util/List;Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/obl;->you(Ljava/util/List;Landroid/content/Intent;)Ljava/util/List;
...
.method public dumpsys(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/obl;->rtg(Ljava/lang/String;Ljava/io/PrintWriter;)V
...
.method public enqueueBroadcastLocked(ZLcom/android/server/am/BroadcastRecord;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/obl;->ssp(ZLcom/android/server/am/BroadcastRecord;)V
...
.method public init()V
    ...
    sget-object p0, Lcom/android/server/am/vdb;->you:Lcom/android/server/ServiceThread;
    ...
    sput-object p0, Lcom/android/server/am/vdb;->you:Lcom/android/server/ServiceThread;
...
.method public init(Lcom/android/server/am/ActivityManagerService;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/obl;->bio(Lcom/android/server/am/ActivityManagerService;)V
...
.method public processOrderedBroadcastForPriorityLocked(Lcom/android/server/am/BroadcastRecord;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/obl;->gwm(Lcom/android/server/am/BroadcastRecord;I)V
...
.method public processParallelBroadcastLocked()V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/obl;->ugm()V
...
.method public skipBroadcastLocked(Lcom/android/server/am/BroadcastFilter;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    invoke-static {p1, p2, p3}, Lcom/android/server/am/obl;->zgw(Lcom/android/server/am/BroadcastFilter;Lcom/android/server/am/BroadcastRecord;Z)Z
...
.method public skipBroadcastLocked(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-static {p1, p2, p3}, Lcom/android/server/am/obl;->obl(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
...
.method public systemReady(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/obl;->oxb(Landroid/content/Context;)V
...
.method public updateAnrCount()V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/zgw;->obl()V
...
.method public updateRcvInfo(ILjava/lang/String;Ljava/lang/String;JJLjava/lang/String;I)V
    ...
    invoke-virtual/range {v1 .. v10}, Lcom/android/server/am/zgw;->oxb(ILjava/lang/String;Ljava/lang/String;JJLjava/lang/String;I)V
...
.method public updateReceiverCount()V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/zgw;->cjf()V
