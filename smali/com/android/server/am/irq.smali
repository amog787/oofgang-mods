...
# static fields
.field private static dma:Lcom/android/server/am/irq; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/irq;->ywr:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/irq;->zta:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/irq;->you:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/am/irq;->rtg:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/irq;->ssp:Ljava/util/HashMap;

    iput v0, p0, Lcom/android/server/am/irq;->cno:I
    ...
    iput-object v1, p0, Lcom/android/server/am/irq;->kth:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;

    iput-object v1, p0, Lcom/android/server/am/irq;->bio:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;
    ...
    iput-object v1, p0, Lcom/android/server/am/irq;->igw:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;

    iput-boolean v0, p0, Lcom/android/server/am/irq;->wtn:Z

    invoke-direct {p0}, Lcom/android/server/am/irq;->kth()V

    invoke-direct {p0}, Lcom/android/server/am/irq;->igw()V
...
.method private bio(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iget-object v2, p0, Lcom/android/server/am/irq;->ssp:Ljava/util/HashMap;

    aget-object v3, v1, v0

    iget-object v3, v3, Lcom/android/server/am/BroadcastQueue;->mQueueName:Ljava/lang/String;

    new-instance v4, Lcom/android/server/am/irq$you;

    aget-object v1, v1, v0

    invoke-direct {v4, p0, v1}, Lcom/android/server/am/irq$you;-><init>(Lcom/android/server/am/irq;Lcom/android/server/am/BroadcastQueue;)V
...
.method private gck(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;)V
    ...
    sget-object v0, Lcom/android/server/am/irq;->ywr:Ljava/lang/Object;
    ...
    iget v3, p0, Lcom/android/server/am/irq;->cno:I
    ...
    iget-object v1, p0, Lcom/android/server/am/irq;->bio:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;

    invoke-direct {p0, p2, v1}, Lcom/android/server/am/irq;->sis(Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;)I

    move-result p2

    iput p2, p0, Lcom/android/server/am/irq;->cno:I
    ...
    iget v2, p0, Lcom/android/server/am/irq;->cno:I
    ...
    :goto_0
    iget v1, p0, Lcom/android/server/am/irq;->cno:I

    const-wide/16 v2, 0x0

    if-gt p2, v1, :cond_1

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/irq;->qbh(Lcom/android/server/am/ActivityManagerService;I)V
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/irq;->zta(Lcom/android/server/am/ActivityManagerService;I)V
    ...
    :cond_1
    iget p2, p0, Lcom/android/server/am/irq;->cno:I
    ...
    invoke-virtual {p0, v4, v1, p2}, Lcom/android/server/am/irq;->bvj(Lcom/android/server/am/BroadcastQueue;ZI)V
...
.method private igw()V
    ...
    iget-object v0, p0, Lcom/android/server/am/irq;->zta:Ljava/util/HashMap;
    ...
    iget-object p0, p0, Lcom/android/server/am/irq;->zta:Ljava/util/HashMap;
...
.method private kth()V
    ...
    iget-object v0, p0, Lcom/android/server/am/irq;->you:Ljava/util/HashMap;
    ...
    iget-object p0, p0, Lcom/android/server/am/irq;->you:Ljava/util/HashMap;
...
.method private qbh(Lcom/android/server/am/ActivityManagerService;I)V
    ...
    iget-object v0, p0, Lcom/android/server/am/irq;->ssp:Ljava/util/HashMap;
    ...
    iput-boolean p2, p1, Lcom/android/server/am/irq$you;->zta:Z

    iget-object p0, p0, Lcom/android/server/am/irq;->tsu:Landroid/os/Handler;
...
.method private sis(Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/irq;->rtg(Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;)I
    ...
    :cond_2
    invoke-direct {p0, p2}, Lcom/android/server/am/irq;->ssp(Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;)I
...
.method private ssp(Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;)I
    ...
    iget-object v0, p0, Lcom/android/server/am/irq;->igw:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;
...
.method public static tsu()Lcom/android/server/am/irq;
    .locals 1

    invoke-static {}, Lcom/android/server/am/irq$sis;->zta()Lcom/android/server/am/irq;
...
.method private ywr(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/irq;->igw:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;

    invoke-direct {p0, v1, p2}, Lcom/android/server/am/irq;->sis(Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;)I

    move-result v1

    iput v1, p0, Lcom/android/server/am/irq;->cno:I
    ...
    iget-object p2, p0, Lcom/android/server/am/irq;->igw:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;
    ...
    iget-object v1, p0, Lcom/android/server/am/irq;->tsu:Landroid/os/Handler;

    iget-object v4, p0, Lcom/android/server/am/irq;->ssp:Ljava/util/HashMap;
...
.method public bvj(Lcom/android/server/am/BroadcastQueue;ZI)V
    ...
    :cond_2
    invoke-virtual {p0, p1}, Lcom/android/server/am/irq;->oif(Lcom/android/server/am/BroadcastQueue;)V
...
.method public cno(Landroid/os/Handler;Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/irq;->tsu:Landroid/os/Handler;

    iput-object p2, p0, Lcom/android/server/am/irq;->sis:Lcom/android/server/am/ActivityManagerService;

    invoke-direct {p0, p2}, Lcom/android/server/am/irq;->bio(Lcom/android/server/am/ActivityManagerService;)V
...
.method dma(Lcom/android/server/am/ActivityManagerService;)V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/am/irq;->you(Ljava/lang/Object;)Landroid/content/pm/ApplicationInfo;
...
.method public oif(Lcom/android/server/am/BroadcastQueue;)V
    ...
    iget-boolean v1, v0, Lcom/android/server/am/irq$you;->zta:Z
    ...
    iput-boolean p0, v0, Lcom/android/server/am/irq$you;->zta:Z
...
.method public wtn(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/irq;->dma(Lcom/android/server/am/ActivityManagerService;)V

    if-eqz p4, :cond_0

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/irq;->gck(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1, p3}, Lcom/android/server/am/irq;->ywr(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;)V
    ...
    sget-object p4, Lcom/android/server/am/irq;->ywr:Ljava/lang/Object;

    monitor-enter p4

    :try_start_1
    iput-object p2, p0, Lcom/android/server/am/irq;->igw:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;

    iget-object p1, p0, Lcom/android/server/am/irq;->bio:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;

    iput-object p1, p0, Lcom/android/server/am/irq;->kth:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;

    iput-object p3, p0, Lcom/android/server/am/irq;->bio:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;
