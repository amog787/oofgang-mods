...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/am/ear$zta;,
        Lcom/android/server/am/ear$tsu;,
        Lcom/android/server/am/ear$rtg;
    }
.end annotation
...
.field private static gck:Lcom/android/server/am/ear; = null
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/ear;->ssp:Z
    ...
    sput-boolean v0, Lcom/android/server/am/ear;->cno:Z

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/am/ear;->bio:Lcom/android/server/am/ActivityManagerService;

    sput-object v0, Lcom/android/server/am/ear;->igw:Lcom/android/server/wm/ActivityTaskManagerService;

    sput-object v0, Lcom/android/server/am/ear;->wtn:Lcom/android/server/wm/ActivityTaskManagerInternal;

    sput-object v0, Lcom/android/server/am/ear;->gck:Lcom/android/server/am/ear;
    ...
    sput-boolean v0, Lcom/android/server/am/ear;->dma:Z
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/ear;->sis:Landroid/os/HandlerThread;
    ...
    new-instance v0, Lcom/android/server/am/ear$rtg;

    iget-object v1, p0, Lcom/android/server/am/ear;->sis:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/server/am/ear$rtg;-><init>(Lcom/android/server/am/ear;Landroid/os/Looper;)V
...
.method private static bvj(Ljava/util/List;Ljava/lang/String;)Z
    ...
    sget-boolean v8, Lcom/android/server/am/ear;->ssp:Z
...
.method private dma()V
    ...
    invoke-direct {p0}, Lcom/android/server/am/ear;->qbh()V

    invoke-static {}, Lcom/android/server/am/ear$zta;->cno()V

    invoke-direct {p0}, Lcom/android/server/am/ear;->wtn()V
...
.method private static gck(Lcom/android/server/am/ProcessRecord;)Z
    ...
    sget-object v0, Lcom/android/server/am/ear;->wtn:Lcom/android/server/wm/ActivityTaskManagerInternal;
...
.method public static declared-synchronized kth()Lcom/android/server/am/ear;
    .locals 2

    const-class v0, Lcom/android/server/am/ear;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/ear;->gck:Lcom/android/server/am/ear;

    if-nez v1, :cond_0

    new-instance v1, Lcom/android/server/am/ear;

    invoke-direct {v1}, Lcom/android/server/am/ear;-><init>()V

    sput-object v1, Lcom/android/server/am/ear;->gck:Lcom/android/server/am/ear;
...
.method private oif(Lorg/json/JSONArray;)V
    ...
    :cond_1
    invoke-static {v3}, Lcom/android/server/am/ear$zta;->dma(Ljava/util/List;)V
    ...
    invoke-static {v3, v2}, Lcom/android/server/am/ear;->bvj(Ljava/util/List;Ljava/lang/String;)Z
    :try_end_0
...
.method private qbh()V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/am/ear;->cno(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method static synthetic rtg()Lcom/android/server/am/ActivityManagerService;
    ...
    sget-object v0, Lcom/android/server/am/ear;->bio:Lcom/android/server/am/ActivityManagerService;
...
.method static synthetic sis()Z
    ...
    sget-boolean v0, Lcom/android/server/am/ear;->cno:Z
...
.method public static ssp(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_2
    invoke-static {p0}, Lcom/android/server/am/ear;->gck(Lcom/android/server/am/ProcessRecord;)Z
...
.method static synthetic tsu()Z
    ...
    sget-boolean v0, Lcom/android/server/am/ear;->dma:Z
...
.method private wtn()V
    ...
    iget-object v1, p0, Lcom/android/server/am/ear;->zta:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/am/ear;->you:Landroid/os/Handler;

    new-instance v3, Lcom/android/server/am/ear$tsu;

    invoke-direct {v3, p0}, Lcom/android/server/am/ear$tsu;-><init>(Lcom/android/server/am/ear;)V
...
.method static synthetic you(Lcom/android/server/am/ear;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/ear;->oif(Lorg/json/JSONArray;)V
...
.method public static ywr(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_3
    :goto_2
    sget-boolean v1, Lcom/android/server/am/ear;->ssp:Z
...
.method static synthetic zta(Lcom/android/server/am/ear;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/ear;->dma()V
...
.method public bio()Landroid/os/Looper;
    ...
    iget-object p0, p0, Lcom/android/server/am/ear;->sis:Landroid/os/HandlerThread;
...
.method public igw(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/ActivityTaskManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/ear;->zta:Landroid/content/Context;

    sput-object p2, Lcom/android/server/am/ear;->bio:Lcom/android/server/am/ActivityManagerService;

    sput-object p3, Lcom/android/server/am/ear;->igw:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    sput-object p1, Lcom/android/server/am/ear;->wtn:Lcom/android/server/wm/ActivityTaskManagerInternal;
