...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/qbh;->ssp:Z

    sput-boolean v1, Lcom/android/server/am/qbh;->cno:Z
    ...
    sput-boolean v0, Lcom/android/server/am/qbh;->kth:Z

    sget-boolean v2, Lcom/android/server/am/qbh;->ssp:Z

    if-nez v2, :cond_0

    sget-boolean v2, Lcom/android/server/am/qbh;->cno:Z
    ...
    :cond_1
    sput-boolean v1, Lcom/android/server/am/qbh;->bio:Z
...
.method static sis(Ljava/lang/String;)V
    ...
    sget-boolean v0, Lcom/android/server/am/qbh;->bio:Z
...
.method private static tsu(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    sput-boolean v0, Lcom/android/server/am/qbh;->cno:Z

    sget-boolean p1, Lcom/android/server/am/qbh;->ssp:Z

    if-nez p1, :cond_1

    if-nez v0, :cond_1

    sget-boolean p1, Lcom/android/server/am/qbh;->kth:Z
    ...
    :cond_1
    :goto_0
    sput-boolean v0, Lcom/android/server/am/qbh;->bio:Z
...
.method static you(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    :pswitch_0
    invoke-static {p1, p0}, Lcom/android/server/am/qbh;->rtg(Ljava/io/PrintWriter;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_1
    invoke-static {p1, p0}, Lcom/android/server/am/qbh;->bio(Ljava/io/PrintWriter;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_2
    invoke-static {p1, p0}, Lcom/android/server/am/qbh;->cno(Ljava/io/PrintWriter;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_3
    invoke-static {p1, p0}, Lcom/android/server/am/qbh;->ssp(Ljava/io/PrintWriter;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_4
    invoke-static {p1}, Lcom/android/server/am/qbh;->zta(Ljava/io/PrintWriter;)V

    goto :goto_3

    :pswitch_5
    invoke-static {p1}, Lcom/android/server/am/qbh;->kth(Ljava/io/PrintWriter;)V

    goto :goto_3

    :pswitch_6
    invoke-static {p1, v7}, Lcom/android/server/am/qbh;->tsu(Ljava/io/PrintWriter;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_7
    invoke-static {p1, v8}, Lcom/android/server/am/qbh;->tsu(Ljava/io/PrintWriter;Ljava/lang/String;)V
