.class public Lcom/android/server/am/lqr$ssp;
...
.method public constructor <init>(Lcom/android/server/am/lqr;Landroid/os/Looper;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/lqr$ssp;->zta:Lcom/android/server/am/lqr;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr$ssp;->zta:Lcom/android/server/am/lqr;

    iget v1, p1, Landroid/os/Message;->what:I

    invoke-static {v0, v1}, Lcom/android/server/am/lqr;->rtg(Lcom/android/server/am/lqr;I)I

    move-result v0

    iget-object v1, p0, Lcom/android/server/am/lqr$ssp;->zta:Lcom/android/server/am/lqr;

    iget v2, p1, Landroid/os/Message;->what:I

    invoke-static {v1, v2}, Lcom/android/server/am/lqr;->ssp(Lcom/android/server/am/lqr;I)I
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr$ssp;->zta:Lcom/android/server/am/lqr;

    check-cast p1, Ljava/lang/String;

    invoke-static {p0, p1}, Lcom/android/server/am/lqr;->bio(Lcom/android/server/am/lqr;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/android/server/am/lqr;->cno(Lcom/android/server/am/lqr;)Lcom/android/server/am/ActivityManagerService;
    ...
    sget-boolean v1, Lcom/android/server/am/lqr;->r:Z
    ...
    invoke-static {p0}, Lcom/android/server/am/lqr;->kth(Lcom/android/server/am/lqr;)Landroid/app/ActivityManager;
