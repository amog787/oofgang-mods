...
.field private static you:Lcom/android/server/am/a$you; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/a$you;->sis:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/am/a$you;->tsu:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/am/a$you;->rtg:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/am/a$you;->ssp:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/am/a$you;->cno:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/am/a$you;->kth:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/am/a$you;->bio:Ljava/util/List;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/am/a$you;->igw:Landroid/util/ArrayMap;
...
.method private constructor <init>()V
    ...
    sget-object v1, Lcom/android/server/am/a$you;->igw:Landroid/util/ArrayMap;

    const-string v2, "android.intent.action.ANY_DATA_STATE"

    invoke-virtual {v1, v2, v0}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-direct {p0}, Lcom/android/server/am/a$you;->tsu()V
...
.method static final bio(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-static {}, Lcom/android/server/am/a$you;->sis()Lcom/android/server/am/a$you;

    move-result-object v2

    iget-boolean v3, p2, Lcom/android/server/am/BroadcastRecord;->ordered:Z

    invoke-direct {v2, p1, p2, v3}, Lcom/android/server/am/a$you;->igw(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-static {}, Lcom/android/server/am/a;->zta()Z
...
.method public static dma(Ljava/util/List;)V
    ...
    sget-object v0, Lcom/android/server/am/a$you;->sis:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/a$you;->sis:Ljava/util/List;
...
.method public static gck(Ljava/util/List;)V
    ...
    sget-object v0, Lcom/android/server/am/a$you;->tsu:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/a$you;->tsu:Ljava/util/List;
...
.method private igw(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    :cond_3
    invoke-static {p1}, Lcom/android/server/am/a;->sis(Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-direct {p0, v0, v4}, Lcom/android/server/am/a$you;->wtn(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_5
    sget-object v4, Lcom/android/server/am/a$you;->sis:Ljava/util/List;

    monitor-enter v4

    :try_start_0
    sget-object v5, Lcom/android/server/am/a$you;->sis:Ljava/util/List;
    ...
    sget-object p0, Lcom/android/server/am/a$you;->cno:Ljava/util/ArrayList;
    ...
    :cond_c
    :goto_0
    invoke-static {}, Lcom/android/server/am/a;->you()Z
    ...
    sget-object v2, Lcom/android/server/am/a$you;->bio:Ljava/util/List;
    ...
    :cond_e
    invoke-direct {p0, v0}, Lcom/android/server/am/a$you;->you(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/a$you;->zta(Ljava/lang/String;)Z
    ...
    :cond_12
    sget-object p0, Lcom/android/server/am/a$you;->kth:Ljava/util/List;
...
.method static final kth(Lcom/android/server/am/BroadcastFilter;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    invoke-direct {v2, v3, p1, p2}, Lcom/android/server/am/a$you;->igw(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
...
.method private static rtg()V
    ...
    sget-object v0, Lcom/android/server/am/a$you;->kth:Ljava/util/List;
...
.method private static sis()Lcom/android/server/am/a$you;
    .locals 1

    sget-object v0, Lcom/android/server/am/a$you;->you:Lcom/android/server/am/a$you;
    ...
    sput-object v0, Lcom/android/server/am/a$you;->you:Lcom/android/server/am/a$you;
...
.method public static ssp()V
    ...
    invoke-static {}, Lcom/android/server/am/a$you;->rtg()V

    sget-boolean v0, Lcom/android/server/am/a;->rtg:Z
    ...
    sget-object v2, Lcom/android/server/am/a$you;->sis:Ljava/util/List;
    ...
    sget-object v2, Lcom/android/server/am/a$you;->kth:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/am/a$you;->kth:Ljava/util/List;

    invoke-direct {v0, v1}, Lcom/android/server/am/a$you;->cno(Ljava/util/List;)V
...
.method private tsu()V
    ...
    sget-object p0, Lcom/android/server/am/a$you;->bio:Ljava/util/List;
...
.method private wtn(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/am/a$you;->igw:Landroid/util/ArrayMap;

    monitor-enter p0

    :try_start_0
    sget-object v0, Lcom/android/server/am/a$you;->igw:Landroid/util/ArrayMap;
...
.method private you(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/am/a$you;->rtg:Ljava/util/ArrayList;

    monitor-enter p0

    :try_start_0
    sget-object v0, Lcom/android/server/am/a$you;->rtg:Ljava/util/ArrayList;
...
.method public static ywr(Ljava/util/List;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/a$you;->cno(Ljava/util/List;)V
...
.method private zta(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/am/a$you;->ssp:Ljava/util/ArrayList;

    monitor-enter p0

    :try_start_0
    sget-object v0, Lcom/android/server/am/a$you;->ssp:Ljava/util/ArrayList;
