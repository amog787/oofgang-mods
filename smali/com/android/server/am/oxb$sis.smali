.class public Lcom/android/server/am/oxb$sis;
...
# static fields
.field private static you:Lcom/android/server/am/oxb$sis; = null
...
.method private static tsu()Lcom/android/server/am/oxb$sis;
    .locals 1

    sget-object v0, Lcom/android/server/am/oxb$sis;->you:Lcom/android/server/am/oxb$sis;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/oxb$sis;

    invoke-direct {v0}, Lcom/android/server/am/oxb$sis;-><init>()V

    sput-object v0, Lcom/android/server/am/oxb$sis;->you:Lcom/android/server/am/oxb$sis;
...
.method static final you(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_1
    invoke-static {}, Lcom/android/server/am/oxb$sis;->tsu()Lcom/android/server/am/oxb$sis;

    move-result-object v0

    invoke-direct {v0, p0}, Lcom/android/server/am/oxb$sis;->sis(Lcom/android/server/am/ProcessRecord;)Z
...
.method static final zta(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-static {}, Lcom/android/server/am/oxb;->rtg()Lcom/android/server/am/ActivityManagerService;
