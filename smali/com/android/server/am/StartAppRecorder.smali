...
# instance fields
.field private rtg:Lcom/android/server/am/l;
...
.field private tsu:Lcom/android/server/am/k;
...
# direct methods
.method private constructor <init>(Landroid/content/Context;Lcom/android/server/am/k;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/android/server/am/StartAppRecorder;->tsu:Lcom/android/server/am/k;
...
.method private ssp(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/StartAppRecorder;->rtg:Lcom/android/server/am/l;

    if-eqz p0, :cond_0

    invoke-virtual {p0, p1}, Lcom/android/server/am/l;->dma(Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public static zta(Landroid/content/Context;Lcom/android/server/am/k;)Lcom/android/server/am/StartAppRecorder;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/server/am/StartAppRecorder;-><init>(Landroid/content/Context;Lcom/android/server/am/k;)V
...
.method public you(Lcom/android/server/am/StartAppRecorder$zta;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/StartAppRecorder;->tsu:Lcom/android/server/am/k;
    ...
    invoke-virtual {p0, v0, v1, v2, p1}, Lcom/android/server/am/k;->vdb(Lcom/android/server/am/StartAppSpecialUidsPolicy$StartType;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
