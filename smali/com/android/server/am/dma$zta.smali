.class Lcom/android/server/am/dma$zta;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/android/server/am/dma;
.end annotation
...
# instance fields
.field final synthetic zta:Lcom/android/server/am/dma;


# direct methods
.method public constructor <init>(Lcom/android/server/am/dma;Landroid/os/Looper;)V
    .locals 0

    iput-object p1, p0, Lcom/android/server/am/dma$zta;->zta:Lcom/android/server/am/dma;
...
.method private bio(Landroid/os/Bundle;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/dma$zta;->zta:Lcom/android/server/am/dma;

    invoke-static {p0}, Lcom/android/server/am/dma;->sis(Lcom/android/server/am/dma;)Ljava/util/HashMap;
    ...
    invoke-interface {v2, v0, v1, p1}, Lcom/android/server/am/bvj;->ywr(ILjava/lang/String;Z)V
...
.method private bvj(Landroid/os/Bundle;)V
    ...
    invoke-interface {v1, v0, p1}, Lcom/android/server/am/bvj;->kth(IZ)V
...
.method private cno(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/dma$zta;->zta:Lcom/android/server/am/dma;

    invoke-static {v1}, Lcom/android/server/am/dma;->sis(Lcom/android/server/am/dma;)Ljava/util/HashMap;
    ...
    invoke-interface {v2, v0, p1}, Lcom/android/server/am/bvj;->noteFreezeStateChange(IZ)V
...
.method private dma(Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v0, p1}, Lcom/android/server/am/bvj;->notePredctionAppChanged(Ljava/lang/String;Z)V
...
.method private gck(Landroid/os/Bundle;)V
    ...
    iget-object p1, p0, Lcom/android/server/am/dma$zta;->zta:Lcom/android/server/am/dma;

    invoke-static {p1}, Lcom/android/server/am/dma;->sis(Lcom/android/server/am/dma;)Ljava/util/HashMap;
    ...
    invoke-interface {v4, v0, v1, v2, v3}, Lcom/android/server/am/bvj;->notePSSChanged(IIJ)V
...
.method private gwm(Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v0, v1, p1}, Lcom/android/server/am/bvj;->you(ILjava/lang/String;Z)V
...
.method private ibl(Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v0, v1, p1}, Lcom/android/server/am/bvj;->gck(ILjava/lang/String;Z)V
...
.method private igw(Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v0, p1}, Lcom/android/server/am/bvj;->cno(Ljava/lang/String;Z)V
...
.method private kth(Landroid/os/Bundle;)V
    ...
    invoke-interface/range {v1 .. v7}, Lcom/android/server/am/bvj;->noteFrontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
...
.method private oif(Landroid/os/Bundle;)V
    ...
    invoke-interface {v1, v0, p1}, Lcom/android/server/am/bvj;->wtn(IZ)V
...
.method private oxb(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lcom/android/server/am/dma$zta;->zta:Lcom/android/server/am/dma;

    invoke-static {v2}, Lcom/android/server/am/dma;->sis(Lcom/android/server/am/dma;)Ljava/util/HashMap;
    ...
    invoke-interface {v3, v0, v1, p1}, Lcom/android/server/am/bvj;->oif(IIZ)V
...
.method private qbh(Landroid/os/Bundle;)V
    ...
    invoke-interface/range {v1 .. v8}, Lcom/android/server/am/bvj;->noteProcessStateChanged(IILjava/lang/String;Ljava/lang/String;ZII)V
...
.method private rtg(Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v0, p1}, Lcom/android/server/am/bvj;->dma(IZ)V
...
.method private sis(Landroid/os/Bundle;)V
    ...
    invoke-interface {v1, v0, p1}, Lcom/android/server/am/bvj;->noteBluetoothConnectedChanged(Ljava/lang/String;Z)V
...
.method private ssp(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lcom/android/server/am/dma$zta;->zta:Lcom/android/server/am/dma;

    invoke-static {v3}, Lcom/android/server/am/dma;->sis(Lcom/android/server/am/dma;)Ljava/util/HashMap;
    ...
    invoke-interface {v4, v0, v1, v2, p1}, Lcom/android/server/am/bvj;->noteFloatWindowChange(Ljava/lang/String;IIZ)V
...
.method private ugm(Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v0, p1}, Lcom/android/server/am/bvj;->sis(II)V
...
.method private vdb(Landroid/os/Bundle;)V
    ...
    invoke-interface {v3, v0, v1, p1}, Lcom/android/server/am/bvj;->noteUserLockAppChanged(Ljava/lang/String;IZ)V
...
.method private wtn(Landroid/os/Bundle;)V
    ...
    invoke-interface {v4, v0, v1, v2, p1}, Lcom/android/server/am/bvj;->noteNotificationChanged(Ljava/lang/String;IIZ)V
...
.method private you(Landroid/os/Bundle;)V
    ...
    invoke-interface {v3, v0, v1, p1}, Lcom/android/server/am/bvj;->tsu(IIZ)V
...
.method private ywr(Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v0, p1}, Lcom/android/server/am/bvj;->igw(II)V
...
.method private zgw(Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v0, p1}, Lcom/android/server/am/bvj;->qbh(IZ)V
...
.method private zta(Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v0, p1}, Lcom/android/server/am/bvj;->zta(IZ)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2, v0}, Lcom/android/server/am/dma;->zta(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->bio(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->ibl(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->bvj(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->oif(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->zta(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->obl(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->tsu(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->rtg(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->zgw(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->ywr(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->ugm(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->gck(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->dma(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->igw(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->cno(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->qbh(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->kth(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->vdb(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->wtn(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->ssp(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->sis(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->you(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->oxb(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/dma$zta;->gwm(Landroid/os/Bundle;)V
    ...
    invoke-static {p0, v0}, Lcom/android/server/am/dma;->you(Lcom/android/server/am/dma;Landroid/os/Bundle;)V
