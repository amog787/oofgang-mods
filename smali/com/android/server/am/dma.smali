...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/am/dma$zta;
    }
.end annotation


# static fields
.field private static rtg:Lcom/android/server/am/dma; = null
...
.field private you:Lcom/android/server/am/dma$zta;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/dma;->zta:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/server/am/dma;->sis:Landroid/os/HandlerThread;
    ...
    new-instance v0, Lcom/android/server/am/dma$zta;

    iget-object v1, p0, Lcom/android/server/am/dma;->sis:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/server/am/dma$zta;-><init>(Lcom/android/server/am/dma;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/am/dma;->you:Lcom/android/server/am/dma$zta;
    ...
    iget-object v4, p0, Lcom/android/server/am/dma;->zta:Ljava/util/HashMap;
...
.method private igw(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lcom/android/server/am/dma;->zta:Ljava/util/HashMap;

    monitor-enter v3

    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/dma;->zta:Ljava/util/HashMap;
    ...
    invoke-interface {v4, p1, v2, v0, v1}, Lcom/android/server/am/bvj;->rtg(Ljava/lang/String;Ljava/lang/String;II)V
...
.method public static rtg()Lcom/android/server/am/dma;
    .locals 1

    sget-object v0, Lcom/android/server/am/dma;->rtg:Lcom/android/server/am/dma;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/dma;

    invoke-direct {v0}, Lcom/android/server/am/dma;-><init>()V

    sput-object v0, Lcom/android/server/am/dma;->rtg:Lcom/android/server/am/dma;
...
.method static synthetic sis(Lcom/android/server/am/dma;)Ljava/util/HashMap;
    .locals 0
...
.method static synthetic you(Lcom/android/server/am/dma;Landroid/os/Bundle;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/dma;->igw(Landroid/os/Bundle;)V
...
.method static synthetic zta(ILjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/android/server/am/dma;->ssp(ILjava/lang/String;)V
...
.method public bio(IZ)V
    ...
    iget-object v0, p0, Lcom/android/server/am/dma;->zta:Ljava/util/HashMap;
    ...
    iget-object p0, p0, Lcom/android/server/am/dma;->you:Lcom/android/server/am/dma$zta;
...
.method public cjf(Lcom/android/server/am/AppRecordManager$ListenerType;Lcom/android/server/am/bvj;)V
    .locals 1
...
.method public oxb(Lcom/android/server/am/AppRecordManager$ListenerType;Lcom/android/server/am/bvj;)V
    .locals 1
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/am/dma;->zta:Ljava/util/HashMap;
...
.method public tsu()V
    ...
    iget-object v5, p0, Lcom/android/server/am/dma;->zta:Ljava/util/HashMap;
