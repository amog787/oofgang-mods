...
.field private static gck:Lcom/android/server/am/zgw; = null
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/zgw;->gwm:Z
...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, Lcom/android/server/am/zgw;->you:J

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/zgw;->rtg:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/zgw;->ssp:Ljava/util/HashMap;

    new-instance v0, Lorg/json/JSONArray;

    invoke-direct {v0}, Lorg/json/JSONArray;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/zgw;->cno:Lorg/json/JSONArray;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/zgw;->kth:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/zgw;->bio:Ljava/lang/Object;

    new-instance v0, Lcom/android/server/am/zgw$zta;

    invoke-direct {v0, p0}, Lcom/android/server/am/zgw$zta;-><init>(Lcom/android/server/am/zgw;)V

    iput-object v0, p0, Lcom/android/server/am/zgw;->igw:Landroid/content/BroadcastReceiver;
...
.method private bvj(Lorg/json/JSONObject;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/zgw;->zta:Landroid/content/Context;
...
.method public static declared-synchronized igw()Lcom/android/server/am/zgw;
    .locals 2

    const-class v0, Lcom/android/server/am/zgw;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/zgw;->gck:Lcom/android/server/am/zgw;
    ...
    sput-object v1, Lcom/android/server/am/zgw;->gck:Lcom/android/server/am/zgw;
...
.method private oif()Z
    ...
    sget-boolean p0, Lcom/android/server/am/zgw;->gwm:Z
...
.method private rtg()Lorg/json/JSONObject;
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/am/zgw;->ssp()V

    const-string v1, "ttm"

    iget-wide v2, p0, Lcom/android/server/am/zgw;->you:J

    invoke-virtual {v0, v1, v2, v3}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;

    const-string v1, "anrCount"

    invoke-virtual {p0}, Lcom/android/server/am/zgw;->kth()I
    ...
    invoke-virtual {p0}, Lcom/android/server/am/zgw;->gck()I
    ...
    iget-object p0, p0, Lcom/android/server/am/zgw;->cno:Lorg/json/JSONArray;
...
.method private sis(Lcom/android/server/am/zgw$sis$zta;)Lorg/json/JSONObject;
    .locals 6
    ...
    iget v0, p1, Lcom/android/server/am/zgw$sis$zta;->cno:I

    const/4 v1, 0x1

    iget-wide v2, p1, Lcom/android/server/am/zgw$sis$zta;->rtg:J
    ...
    :cond_0
    iget v0, p1, Lcom/android/server/am/zgw$sis$zta;->kth:I

    iget-wide v4, p1, Lcom/android/server/am/zgw$sis$zta;->ssp:J
...
.method private ssp()V
    ...
    iget-object v0, p0, Lcom/android/server/am/zgw;->rtg:Ljava/util/HashMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/zgw;->rtg:Ljava/util/HashMap;
    ...
    check-cast v3, Lcom/android/server/am/zgw$sis$zta;
    ...
    :goto_1
    :try_start_1
    iget-object v9, p0, Lcom/android/server/am/zgw;->cno:Lorg/json/JSONArray;
    ...
    invoke-direct {p0, v3}, Lcom/android/server/am/zgw;->sis(Lcom/android/server/am/zgw$sis$zta;)Lorg/json/JSONObject;
    ...
    iget-object v6, v3, Lcom/android/server/am/zgw$sis$zta;->you:Ljava/lang/String;

    invoke-virtual {v4, v5, v6}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v5, "appVersionCode"

    iget-object v6, v3, Lcom/android/server/am/zgw$sis$zta;->sis:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/am/zgw;->cno:Lorg/json/JSONArray;
...
.method public static tsu(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_5
    invoke-static {p0}, Lcom/android/server/am/zgw$you;->you(Ljava/lang/String;)Ljava/lang/String;
...
.method private ugm()V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/zgw;->ibl()V

    invoke-virtual {p0}, Lcom/android/server/am/zgw;->vdb()V

    invoke-virtual {p0}, Lcom/android/server/am/zgw;->zgw()V

    invoke-direct {p0}, Lcom/android/server/am/zgw;->gwm()V
...
.method public static you(Ljava/util/HashMap;)Ljava/util/HashMap;
    ...
    check-cast v1, Lcom/android/server/am/zgw$sis$zta;
...
.method static synthetic zta()Z
    ...
    invoke-static {}, Lcom/android/server/am/zgw;->qbh()Z
...
.method public cjf()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/am/zgw;->bio:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget v1, p0, Lcom/android/server/am/zgw;->tsu:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/android/server/am/zgw;->tsu:I
...
.method public cno(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0}, Lcom/android/server/am/zgw;->rtg()Lorg/json/JSONObject;
    ...
    invoke-static {v0, v1}, Lcom/android/server/am/zgw;->tsu(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-wide v3, p0, Lcom/android/server/am/zgw;->you:J
    ...
    invoke-virtual {p0}, Lcom/android/server/am/zgw;->wtn()Ljava/util/HashMap;
...
.method public ear()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/am/zgw;->bvj(Lorg/json/JSONObject;Ljava/lang/String;)V

    invoke-direct {p0}, Lcom/android/server/am/zgw;->ugm()V
...
.method public gck()I
    ...
    :try_start_0
    iget p0, p0, Lcom/android/server/am/zgw;->tsu:I
...
.method public ibl()V
    ...
    iget-object v0, p0, Lcom/android/server/am/zgw;->kth:Ljava/lang/Object;
    ...
    :try_start_0
    iput v1, p0, Lcom/android/server/am/zgw;->sis:I
...
.method public kth()I
    ...
    :try_start_0
    iget p0, p0, Lcom/android/server/am/zgw;->sis:I
...
.method public obl()V
    ...
    :try_start_0
    iget v1, p0, Lcom/android/server/am/zgw;->sis:I
...
.method public oxb(ILjava/lang/String;Ljava/lang/String;JJLjava/lang/String;I)V
    ...
    :try_start_0
    invoke-static {p9}, Lcom/android/server/am/zgw;->bio(I)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/am/zgw;->rtg:Ljava/util/HashMap;

    invoke-virtual {v2, v1}, Ljava/util/HashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/android/server/am/zgw$sis$zta;

    if-nez v2, :cond_2

    new-instance v2, Lcom/android/server/am/zgw$sis$zta;

    invoke-direct {v2, p2, p3, p9, p8}, Lcom/android/server/am/zgw$sis$zta;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/am/zgw$sis$zta;->toString()Ljava/lang/String;
    ...
    iget-wide p6, v2, Lcom/android/server/am/zgw$sis$zta;->rtg:J

    add-long/2addr p6, p4

    iput-wide p6, v2, Lcom/android/server/am/zgw$sis$zta;->rtg:J

    iget p1, v2, Lcom/android/server/am/zgw$sis$zta;->cno:I

    add-int/2addr p1, p2

    iput p1, v2, Lcom/android/server/am/zgw$sis$zta;->cno:I

    goto :goto_0

    :cond_3
    iget-wide p3, v2, Lcom/android/server/am/zgw$sis$zta;->ssp:J

    add-long/2addr p3, p6

    iput-wide p3, v2, Lcom/android/server/am/zgw$sis$zta;->ssp:J

    iget p1, v2, Lcom/android/server/am/zgw$sis$zta;->kth:I

    add-int/2addr p1, p2

    iput p1, v2, Lcom/android/server/am/zgw$sis$zta;->kth:I
    ...
    iget-object p0, p0, Lcom/android/server/am/zgw;->rtg:Ljava/util/HashMap;
...
.method public wtn()Ljava/util/HashMap;
    ...
    invoke-static {p0}, Lcom/android/server/am/zgw;->you(Ljava/util/HashMap;)Ljava/util/HashMap;
...
.method public ywr(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/zgw;->zta:Landroid/content/Context;

    invoke-direct {p0}, Lcom/android/server/am/zgw;->dma()J
    ...
    invoke-direct {p0}, Lcom/android/server/am/zgw;->oif()Z
    ...
    iget-object v0, p0, Lcom/android/server/am/zgw;->zta:Landroid/content/Context;

    iget-object p0, p0, Lcom/android/server/am/zgw;->igw:Landroid/content/BroadcastReceiver;
