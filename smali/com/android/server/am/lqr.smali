...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/am/lqr$ssp;
    }
.end annotation
...
.field private bvj:Lcom/android/server/am/l;
...
.field private gwm:Lcom/android/server/am/b;
...
.field private ibl:Lcom/android/server/am/i;
...
.field private obl:Lcom/android/server/am/lqr$rtg;
...
.field private ugm:Lcom/android/server/am/n;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/server/am/lqr;->i:Z

    sget-boolean v1, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v1, Lcom/android/server/am/lqr;->n:Z

    const/4 v1, 0x0

    sput-object v1, Lcom/android/server/am/lqr;->p:Landroid/os/HandlerThread;

    sput-boolean v2, Lcom/android/server/am/lqr;->q:Z

    sput-boolean v0, Lcom/android/server/am/lqr;->r:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/lqr;->veq:Ljava/util/HashSet;

    new-instance v0, Lcom/android/server/am/lqr$zta;

    invoke-direct {v0, p0}, Lcom/android/server/am/lqr$zta;-><init>(Lcom/android/server/am/lqr;)V

    iput-object v0, p0, Lcom/android/server/am/lqr;->cgv:Landroid/content/BroadcastReceiver;

    new-instance v0, Lcom/android/server/am/lqr$sis;

    invoke-direct {v0, p0}, Lcom/android/server/am/lqr$sis;-><init>(Lcom/android/server/am/lqr;)V

    iput-object v0, p0, Lcom/android/server/am/lqr;->vju:Landroid/content/BroadcastReceiver;

    iput-object p1, p0, Lcom/android/server/am/lqr;->gck:Landroid/content/Context;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/lqr;->cjf:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/lqr;->hmo:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/lqr;->fto:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/lqr;->lqr:Ljava/util/List;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/lqr;->ear:Ljava/util/Map;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/lqr;->ire:Ljava/util/List;

    const-wide/16 v0, 0x1f4

    iput-wide v0, p0, Lcom/android/server/am/lqr;->vdb:J
    ...
    iput-object p1, p0, Lcom/android/server/am/lqr;->oxb:Ljava/util/Set;

    iget-object p1, p0, Lcom/android/server/am/lqr;->gck:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/android/server/am/lqr;->kth:Landroid/app/ActivityManager;

    invoke-direct {p0}, Lcom/android/server/am/lqr;->bud()V

    return-void
.end method

.method static synthetic bio(Lcom/android/server/am/lqr;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->p(Ljava/lang/String;)V
...
.method private bud()V
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr;->veq:Ljava/util/HashSet;

    const-string v1, "com.igexin.sdk.PushActivityTask"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    iget-object p0, p0, Lcom/android/server/am/lqr;->veq:Ljava/util/HashSet;
...
.method static synthetic bvj(Lcom/android/server/am/lqr;)Lcom/android/server/am/StartAppSpecialUidsPolicy;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/lqr;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
...
.method private cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/lqr;->c(I)Z
    ...
    :goto_1
    iget-object p0, p0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/StartAppRecorder;
    ...
    iget-object p1, p0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/StartAppRecorder;
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr;->oxb:Ljava/util/Set;
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/lqr;->b(I)Z
...
.method private cjf()V
    ...
    iget-object v1, p0, Lcom/android/server/am/lqr;->cjf:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/lqr;->ear:Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/android/server/am/lqr;->hmo:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/lqr;->fto:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/lqr;->lqr:Ljava/util/List;
...
.method static synthetic cno(Lcom/android/server/am/lqr;)Lcom/android/server/am/ActivityManagerService;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/lqr;->cno:Lcom/android/server/am/ActivityManagerService;

    return-object p0
.end method

.method static synthetic dma(Lcom/android/server/am/lqr;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/lqr;->tsu:Z
...
.method private synthetic e(Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->n(Lorg/json/JSONArray;)V
...
.method private ear(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
...
.method private g(Landroid/content/pm/ActivityInfo;I)Z
    ...
    iget-boolean p2, p0, Lcom/android/server/am/lqr;->ssp:Z

    const/4 v0, 0x1

    if-eqz p2, :cond_2

    iget-object p2, p0, Lcom/android/server/am/lqr;->fto:Ljava/util/List;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/lqr;->gck:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/android/server/am/lqr;->veq:Ljava/util/HashSet;
    ...
    iget-object p2, p0, Lcom/android/server/am/lqr;->veq:Ljava/util/HashSet;
    ...
    invoke-static {p2}, Lcom/android/server/am/lqr;->h(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr;->ugm:Lcom/android/server/am/n;

    iget p1, p1, Landroid/content/pm/ApplicationInfo;->uid:I

    invoke-virtual {p0, p1}, Lcom/android/server/am/n;->rtg(I)V
...
.method static synthetic gck(II)I
    ...
    invoke-static {p0, p1}, Lcom/android/server/am/lqr;->zgw(II)I
...
.method static synthetic gwm(Lcom/android/server/am/lqr;)Lcom/android/server/am/StartAppConfigManager;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
...
.method protected static h(Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lcom/android/server/am/lqr;->i(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public static hmo(Landroid/content/Context;)Lcom/android/server/am/lqr;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lcom/android/server/am/lqr;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/android/server/am/lqr;->o:Lcom/android/server/am/lqr;

    :cond_0
    sget-object p0, Lcom/android/server/am/lqr;->o:Lcom/android/server/am/lqr;
...
.method static synthetic ibl(Lcom/android/server/am/lqr;)Lcom/android/server/am/l;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/lqr;->bvj:Lcom/android/server/am/l;

    return-object p0
.end method

.method static synthetic igw(Lcom/android/server/am/lqr;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->zta(I)V

    return-void
.end method

.method protected static ire()Lcom/android/server/am/lqr;
    .locals 1
...
.method private j()V
    ...
    sput-object v0, Lcom/android/server/am/lqr;->p:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->start()V

    new-instance v0, Lcom/android/server/am/lqr$ssp;

    sget-object v1, Lcom/android/server/am/lqr;->p:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/server/am/lqr$ssp;-><init>(Lcom/android/server/am/lqr;Landroid/os/Looper;)V

    sput-object v0, Lcom/android/server/am/lqr;->s:Landroid/os/Handler;
    ...
    sget-boolean v1, Lcom/android/server/am/lqr;->i:Z

    if-eqz v1, :cond_0

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/android/server/am/lqr;->zta:Z

    iput-boolean v1, p0, Lcom/android/server/am/lqr;->you:Z

    iput-boolean v1, p0, Lcom/android/server/am/lqr;->sis:Z

    iput-boolean v1, p0, Lcom/android/server/am/lqr;->tsu:Z

    iput-boolean v1, p0, Lcom/android/server/am/lqr;->rtg:Z

    iput-boolean v1, p0, Lcom/android/server/am/lqr;->ssp:Z
    ...
    invoke-direct {p0}, Lcom/android/server/am/lqr;->k()V

    :goto_0
    invoke-direct {p0}, Lcom/android/server/am/lqr;->vju()V

    iget-object v1, p0, Lcom/android/server/am/lqr;->gck:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/am/lqr;->cgv:Landroid/content/BroadcastReceiver;

    invoke-virtual {v1, v2, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-direct {p0}, Lcom/android/server/am/lqr;->m()V

    new-instance v0, Lcom/oneplus/config/ConfigObserver;

    iget-object v1, p0, Lcom/android/server/am/lqr;->gck:Landroid/content/Context;

    sget-object v2, Lcom/android/server/am/lqr;->s:Landroid/os/Handler;

    new-instance v3, Lcom/android/server/am/lqr$you;

    invoke-direct {v3, p0}, Lcom/android/server/am/lqr$you;-><init>(Lcom/android/server/am/lqr;)V

    const-string v4, "AppBoot"

    invoke-direct {v0, v1, v2, v3, v4}, Lcom/oneplus/config/ConfigObserver;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/oneplus/config/ConfigObserver$ConfigUpdater;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/am/lqr;->zgw:Lcom/oneplus/config/ConfigObserver;
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/server/am/sis;-><init>(Lcom/android/server/am/lqr;Lorg/json/JSONArray;)V
...
.method private k()V
    ...
    iget-boolean v0, p0, Lcom/android/server/am/lqr;->zta:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/am/lqr;->you:Z

    iput-boolean v4, p0, Lcom/android/server/am/lqr;->sis:Z

    iput-boolean v4, p0, Lcom/android/server/am/lqr;->tsu:Z

    iput-boolean v3, p0, Lcom/android/server/am/lqr;->rtg:Z

    iput-boolean v3, p0, Lcom/android/server/am/lqr;->ssp:Z
    ...
    :goto_0
    iput-boolean v4, p0, Lcom/android/server/am/lqr;->you:Z

    iput-boolean v4, p0, Lcom/android/server/am/lqr;->sis:Z

    iput-boolean v4, p0, Lcom/android/server/am/lqr;->tsu:Z

    iput-boolean v4, p0, Lcom/android/server/am/lqr;->rtg:Z

    iput-boolean v4, p0, Lcom/android/server/am/lqr;->ssp:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/lqr;->you:Z
    ...
    iget-boolean p0, p0, Lcom/android/server/am/lqr;->sis:Z
...
.method static synthetic kth(Lcom/android/server/am/lqr;)Landroid/app/ActivityManager;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/lqr;->kth:Landroid/app/ActivityManager;
...
.method private m()V
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr;->gck:Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr;->vju:Landroid/content/BroadcastReceiver;
...
.method private n(Lorg/json/JSONArray;)V
    ...
    iget-object v3, p0, Lcom/android/server/am/lqr;->lqr:Ljava/util/List;
    ...
    :try_start_1
    iget-object v4, p0, Lcom/android/server/am/lqr;->lqr:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/am/lqr;->lqr:Ljava/util/List;
    ...
    sget-boolean v4, Lcom/android/server/am/l;->veq:Z

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z

    move-result v3

    sput-boolean v3, Lcom/android/server/am/l;->veq:Z

    const-string v3, "times"

    sget v4, Lcom/android/server/am/l;->fto:I

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I

    move-result v3

    sput v3, Lcom/android/server/am/l;->fto:I

    const-string v3, "duration"

    sget-wide v4, Lcom/android/server/am/l;->lqr:J

    invoke-virtual {v2, v3, v4, v5}, Lorg/json/JSONObject;->optLong(Ljava/lang/String;J)J

    move-result-wide v3

    sput-wide v3, Lcom/android/server/am/l;->lqr:J
    ...
    sget-object v3, Lcom/android/server/am/l;->cgv:Ljava/util/List;
    ...
    sget-object v5, Lcom/android/server/am/l;->cgv:Ljava/util/List;
    ...
    sget-wide v4, Lcom/android/server/am/i;->wtn:J

    invoke-virtual {v2, v3, v4, v5}, Lorg/json/JSONObject;->optLong(Ljava/lang/String;J)J

    move-result-wide v3

    sput-wide v3, Lcom/android/server/am/i;->wtn:J

    const-string v3, "max_count"

    sget v4, Lcom/android/server/am/i;->gck:I

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I

    move-result v3

    sput v3, Lcom/android/server/am/i;->gck:I

    const-string v3, "threshold_adj"

    sget v4, Lcom/android/server/am/i;->dma:I

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I

    move-result v3

    sput v3, Lcom/android/server/am/i;->dma:I
    ...
    iget-object v3, p0, Lcom/android/server/am/lqr;->ibl:Lcom/android/server/am/i;

    iget-object v3, v3, Lcom/android/server/am/i;->you:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v4, p0, Lcom/android/server/am/lqr;->ibl:Lcom/android/server/am/i;

    iget-object v4, v4, Lcom/android/server/am/i;->you:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Lcom/android/server/am/lqr;->ibl:Lcom/android/server/am/i;

    iget-object v6, v6, Lcom/android/server/am/i;->you:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lcom/android/server/am/lqr;->fto:Ljava/util/List;
    ...
    :try_start_5
    iget-object v5, p0, Lcom/android/server/am/lqr;->fto:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/server/am/lqr;->fto:Ljava/util/List;
    ...
    iget-wide v4, p0, Lcom/android/server/am/lqr;->vdb:J

    invoke-virtual {v2, v3, v4, v5}, Lorg/json/JSONObject;->optLong(Ljava/lang/String;J)J

    move-result-wide v2

    iput-wide v2, p0, Lcom/android/server/am/lqr;->vdb:J
    ...
    iget-object v3, p0, Lcom/android/server/am/lqr;->veq:Ljava/util/HashSet;
    ...
    :try_start_7
    iget-object v4, p0, Lcom/android/server/am/lqr;->veq:Ljava/util/HashSet;
    ...
    iget-object v6, p0, Lcom/android/server/am/lqr;->veq:Ljava/util/HashSet;
    ...
    iget-object v3, p0, Lcom/android/server/am/lqr;->hmo:Ljava/util/List;
    ...
    :try_start_9
    iget-object v4, p0, Lcom/android/server/am/lqr;->hmo:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/am/lqr;->hmo:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/android/server/am/lqr;->cjf:Ljava/util/List;
    ...
    :try_start_b
    iget-object v4, p0, Lcom/android/server/am/lqr;->cjf:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/am/lqr;->cjf:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    iget-object v7, p0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    iget-boolean v4, p0, Lcom/android/server/am/lqr;->zta:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/am/lqr;->you:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/am/lqr;->tsu:Z

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/server/am/lqr;->tsu:Z

    const-string v3, "service_restart_control"

    iget-boolean v4, p0, Lcom/android/server/am/lqr;->sis:Z

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/server/am/lqr;->sis:Z

    const-string v3, "debug"

    sget-boolean v4, Lcom/android/server/am/lqr;->n:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/am/lqr;->rtg:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/am/lqr;->ssp:Z
    ...
    sget-boolean v4, Lcom/android/server/am/lqr;->r:Z

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z

    move-result v2

    sput-boolean v2, Lcom/android/server/am/lqr;->r:Z
    :try_end_c
...
.method private o(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)V
    ...
    invoke-static {v2}, Lcom/android/server/am/l;->sis(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/android/server/am/l;->you(Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/android/server/am/l;->zta(Ljava/lang/String;)V
...
.method static synthetic oif(Lcom/android/server/am/lqr;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/lqr;->cjf()V
...
.method private p(Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v0, Lcom/android/server/am/lqr;->t:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->o(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)V

    :cond_1
    return-void
.end method

.method static synthetic qbh(Lcom/android/server/am/lqr;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/lqr;->ssp:Z
...
.method private qeg(Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/lqr;->a(Ljava/lang/String;)Z
...
.method static synthetic rtg(Lcom/android/server/am/lqr;I)I
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->obl(I)I
...
.method static synthetic sis(Lcom/android/server/am/lqr;)Z
    .locals 0
...
.method static synthetic ssp(Lcom/android/server/am/lqr;I)I
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->oxb(I)I
...
.method static synthetic tsu(Lcom/android/server/am/lqr;)V
    .locals 0
...
.method static synthetic ugm(Lcom/android/server/am/lqr;)Ljava/util/HashSet;
    .locals 0
...
.method private vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/lqr;->irq(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/server/am/lqr;->les(Ljava/lang/String;)Z
...
.method private vju()V
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr;->bio:Lcom/android/server/vdb;
    ...
    iput-object v0, p0, Lcom/android/server/am/lqr;->bio:Lcom/android/server/vdb;
    ...
    iput-object v0, p0, Lcom/android/server/am/lqr;->igw:Lcom/android/server/am/AppRecordManagerService;

    invoke-static {}, Lcom/android/server/am/StartAppConfigManager;->tsu()Lcom/android/server/am/StartAppConfigManager;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    iput-object v0, p0, Lcom/android/server/am/lqr;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;

    iget-object v0, p0, Lcom/android/server/am/lqr;->gck:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/server/am/l;->gck(Landroid/content/Context;)Lcom/android/server/am/l;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/lqr;->bvj:Lcom/android/server/am/l;

    iget-object v0, p0, Lcom/android/server/am/lqr;->cno:Lcom/android/server/am/ActivityManagerService;

    invoke-static {v0}, Lcom/android/server/am/i;->zta(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/i;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/lqr;->ibl:Lcom/android/server/am/i;

    iget-object v0, p0, Lcom/android/server/am/lqr;->gck:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/server/am/b;->zgw(Landroid/content/Context;)Lcom/android/server/am/b;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/lqr;->gwm:Lcom/android/server/am/b;

    iget-object v0, p0, Lcom/android/server/am/lqr;->gck:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/server/am/n;->you(Landroid/content/Context;)Lcom/android/server/am/n;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/lqr;->ugm:Lcom/android/server/am/n;

    invoke-static {}, Lcom/android/server/OnePlusUtil$you;->tsu()Lcom/android/server/OnePlusUtil$you;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/lqr;->wtn:Lcom/android/server/OnePlusUtil$you;

    iget-object v0, p0, Lcom/android/server/am/lqr;->gck:Landroid/content/Context;

    iget-object v1, p0, Lcom/android/server/am/lqr;->bvj:Lcom/android/server/am/l;

    invoke-static {v0, v1}, Lcom/android/server/am/StartAppRecorder;->zta(Landroid/content/Context;Lcom/android/server/am/l;)Lcom/android/server/am/StartAppRecorder;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/StartAppRecorder;

    new-instance v0, Lcom/android/server/am/lqr$rtg;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/android/server/am/lqr$rtg;-><init>(Lcom/android/server/am/lqr;Lcom/android/server/am/lqr$zta;)V

    iput-object v0, p0, Lcom/android/server/am/lqr;->obl:Lcom/android/server/am/lqr$rtg;
    ...
    invoke-static {v1, v0}, Lcom/android/server/am/AppRecordManager;->vdb(Lcom/android/server/am/AppRecordManager$ListenerType;Lcom/android/server/am/bvj;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/lqr;->obl:Lcom/android/server/am/lqr$rtg;
    ...
    :try_start_0
    invoke-static {}, Lcom/android/server/am/ibl;->zta()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/am/lqr;->dma:Z
...
.method static synthetic wtn(Lcom/android/server/am/lqr;Lorg/json/JSONArray;)V
    .locals 0
...
.method static synthetic you(Lcom/android/server/am/lqr;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/lqr;->you:Z

    return p0
.end method

.method static synthetic ywr(Lcom/android/server/am/lqr;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/lqr;->rtg:Z
...
.method private zta(I)V
    ...
    sget-object p0, Lcom/android/server/am/lqr;->s:Landroid/os/Handler;

    const/4 v0, 0x1

    invoke-static {p1, v0}, Lcom/android/server/am/lqr;->zgw(II)I
...
.method protected a(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr;->lqr:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/server/am/lqr;->igw:Lcom/android/server/am/AppRecordManagerService;
...
.method public activityFinished(Landroid/content/pm/ActivityInfo;)V
    ...
    iget-object v2, p0, Lcom/android/server/am/lqr;->ugm:Lcom/android/server/am/n;

    invoke-virtual {v2, v0}, Lcom/android/server/am/n;->tsu(I)Z
    ...
    invoke-static {v0, v2}, Lcom/android/server/am/lqr;->zgw(II)I
    ...
    sget-object v0, Lcom/android/server/am/lqr;->s:Landroid/os/Handler;

    iget-wide v1, p0, Lcom/android/server/am/lqr;->vdb:J
...
.method public addAccessibilityService(Landroid/content/ComponentName;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/lqr;->lqr(Ljava/lang/String;)I
...
.method public appBecomeVisible(I)V
    ...
    iget-boolean v0, p0, Lcom/android/server/am/lqr;->dma:Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/n;->zta(I)V
...
.method public canActivityGo(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ActivityInfo;)Z
    ...
    iget-boolean v2, v0, Lcom/android/server/am/lqr;->zta:Z

    const/4 v3, 0x1

    if-eqz v2, :cond_a

    iget-boolean v2, v0, Lcom/android/server/am/lqr;->dma:Z
    ...
    iget-object v0, v0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/StartAppRecorder;
    ...
    :cond_1
    invoke-virtual {v0, v2}, Lcom/android/server/am/lqr;->a(Ljava/lang/String;)Z
    ...
    iget-object v1, v0, Lcom/android/server/am/lqr;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    :cond_2
    iget-object v4, v0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v4, v14, v12}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_3
    iget-object v4, v0, Lcom/android/server/am/lqr;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    sget-object v4, Lcom/android/server/am/lqr$tsu;->zta:[I
    ...
    iget-object v4, v0, Lcom/android/server/am/lqr;->bvj:Lcom/android/server/am/l;
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/android/server/am/l;->rtg(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/StartAppRecorder$zta;)V

    sget-object v2, Lcom/android/server/am/lqr$tsu;->zta:[I
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/am/lqr;->c(I)Z

    move-result v2

    if-eqz v2, :cond_5

    invoke-direct {v0, v1, v14}, Lcom/android/server/am/lqr;->g(Landroid/content/pm/ActivityInfo;I)Z
    ...
    iget-object v1, v0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/StartAppRecorder;

    invoke-virtual {v1, v12}, Lcom/android/server/am/StartAppRecorder;->you(Lcom/android/server/am/StartAppRecorder$zta;)V

    iget-object v0, v0, Lcom/android/server/am/lqr;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    iget-object v1, v0, Lcom/android/server/am/lqr;->oxb:Ljava/util/Set;
...
.method public canInstrumentationGo(Landroid/content/ComponentName;I)Z
    ...
    iget-boolean v1, v0, Lcom/android/server/am/lqr;->zta:Z

    const/4 v8, 0x1

    if-eqz v1, :cond_d

    iget-boolean v1, v0, Lcom/android/server/am/lqr;->dma:Z
    ...
    :cond_0
    iget-object v1, v0, Lcom/android/server/am/lqr;->igw:Lcom/android/server/am/AppRecordManagerService;
    ...
    invoke-virtual {v0, v15, v4}, Lcom/android/server/am/lqr;->veq(Ljava/lang/String;I)I
    ...
    :cond_2
    invoke-virtual {v0, v15}, Lcom/android/server/am/lqr;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v6}, Lcom/android/server/am/lqr;->c(I)Z
    ...
    :cond_3
    iget-object v9, v0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v9, v6, v7}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    sget-object v1, Lcom/android/server/am/lqr$tsu;->zta:[I
    ...
    invoke-direct {v0, v15, v13, v11}, Lcom/android/server/am/lqr;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {v0, v1, v13, v11}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    invoke-virtual {v0, v13}, Lcom/android/server/am/lqr;->c(I)Z

    move-result v1

    if-eqz v1, :cond_9

    iget-object v0, v0, Lcom/android/server/am/lqr;->oxb:Ljava/util/Set;
...
.method public canJobSchedulerGo(Ljava/lang/Object;)Z
    ...
    invoke-direct {v1, v3}, Lcom/android/server/am/ugm;-><init>(Ljava/lang/Object;)V

    :try_start_0
    invoke-virtual {v1}, Lcom/android/server/am/ugm;->sis()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v1}, Lcom/android/server/am/ugm;->you()Landroid/content/ComponentName;
    ...
    invoke-virtual {v1}, Lcom/android/server/am/ugm;->zta()I
    ...
    invoke-virtual {v1}, Lcom/android/server/am/ugm;->tsu()I
    ...
    invoke-virtual {v0, v9}, Lcom/android/server/am/lqr;->a(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-virtual {v0, v10, v1}, Lcom/android/server/am/lqr;->veq(Ljava/lang/String;I)I
    ...
    :cond_2
    iget-object v3, v0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v15, v13, v11}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_3
    iget-object v3, v0, Lcom/android/server/am/lqr;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    sget-object v3, Lcom/android/server/am/lqr$tsu;->zta:[I
    ...
    invoke-direct {v0, v10, v13, v11}, Lcom/android/server/am/lqr;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {v0, v3, v13, v11}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_5
    invoke-virtual {v0, v1}, Lcom/android/server/am/lqr;->c(I)Z
...
.method public canNotificationListenerServiceGo(Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/lqr;->lqr(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/lqr;->c(I)Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/am/lqr;->oxb:Ljava/util/Set;
    ...
    :cond_3
    iget-object v2, p0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {p0, v2, p1, v8}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_4
    invoke-direct {p0, v0, p1, v8}, Lcom/android/server/am/lqr;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V

    sget-object v0, Lcom/android/server/am/lqr$tsu;->zta:[I
    ...
    invoke-direct {p0, v0, p1, v8}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_9
    iget-object v0, p0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/StartAppRecorder;
...
.method public canProcGo(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/am/lqr;->c(I)Z
    ...
    :cond_3
    iget-object p2, p0, Lcom/android/server/am/lqr;->bio:Lcom/android/server/vdb;
    ...
    :cond_4
    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->qeg(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_5
    iget-object p2, p0, Lcom/android/server/am/lqr;->ire:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/server/am/lqr;->ire:Ljava/util/List;
    ...
    :cond_6
    iget-object p2, p0, Lcom/android/server/am/lqr;->oxb:Ljava/util/Set;
...
.method public canProviderGo(Ljava/lang/String;ILjava/lang/String;Lcom/android/server/am/ContentProviderRecord;)Z
    ...
    iget-boolean v2, v0, Lcom/android/server/am/lqr;->you:Z
    ...
    iget-object v2, v0, Lcom/android/server/am/lqr;->igw:Lcom/android/server/am/AppRecordManagerService;
    ...
    :cond_3
    invoke-virtual {v0, v14}, Lcom/android/server/am/lqr;->a(Ljava/lang/String;)Z
    ...
    iget-object v2, v0, Lcom/android/server/am/lqr;->oxb:Ljava/util/Set;
    ...
    :cond_4
    iget-object v8, v0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v11, v1, v6}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_5
    iget-object v5, v0, Lcom/android/server/am/lqr;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    invoke-direct {v0, v14, v1, v10}, Lcom/android/server/am/lqr;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {v0, v4, v1, v10}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/android/server/am/l;->ssp(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    :cond_9
    iget-object v2, v0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/StartAppRecorder;
...
.method public canReceiverGo(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_3
    invoke-virtual {v0, v3}, Lcom/android/server/am/lqr;->lqr(Ljava/lang/String;)I
    ...
    :cond_5
    invoke-virtual {v0, v3}, Lcom/android/server/am/lqr;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/am/lqr;->c(I)Z
    ...
    :cond_6
    iget-object v10, v0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v6, v7, v8}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_7
    iget-object v10, v0, Lcom/android/server/am/lqr;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    sget-object v10, Lcom/android/server/am/lqr$tsu;->zta:[I
    ...
    invoke-direct {v0, v3, v7, v8}, Lcom/android/server/am/lqr;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {v0, v2, v7, v8}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_9
    iget-object v2, v0, Lcom/android/server/am/lqr;->bvj:Lcom/android/server/am/l;
    ...
    invoke-virtual/range {v1 .. v8}, Lcom/android/server/am/l;->cno(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Lcom/android/server/am/StartAppRecorder$zta;)V
...
.method public canScheduleServiceRestart(Lcom/android/server/am/ProcessRecord;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/lqr;->sis:Z
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/am/lqr;->cjf:Ljava/util/List;
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/server/am/lqr;->bio:Lcom/android/server/vdb;
    ...
    :cond_3
    iget-object v4, p0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {p0, p1, v2, v3}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
...
.method public canServiceGo(Ljava/lang/String;ILandroid/content/Intent;Lcom/android/server/am/ServiceRecord;)Z
    ...
    :cond_2
    invoke-virtual {v0, v11}, Lcom/android/server/am/lqr;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v15}, Lcom/android/server/am/lqr;->c(I)Z
    ...
    :cond_3
    iget-object v2, v0, Lcom/android/server/am/lqr;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v7, v15, v13}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    invoke-direct {v0, v11, v15, v13}, Lcom/android/server/am/lqr;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {v0, v1, v15, v13}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_6
    iget-object v1, v0, Lcom/android/server/am/lqr;->bvj:Lcom/android/server/am/l;
    ...
    invoke-virtual/range {v1 .. v8}, Lcom/android/server/am/l;->bio(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/ServiceRecord;ILandroid/content/Intent;Lcom/android/server/am/StartAppRecorder$zta;)V
...
.method protected d(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr;->ear:Ljava/util/Map;
...
.method public dispatchBlockedAuthes(Landroid/app/IApplicationThread;Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, p2}, Lcom/android/server/am/lqr;->ear(Ljava/lang/String;)Ljava/util/List;
...
.method public synthetic f(Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->e(Lorg/json/JSONArray;)V
...
.method public getJobTimeout()J
    ...
    iget-boolean p0, p0, Lcom/android/server/am/lqr;->zta:Z

    if-eqz p0, :cond_0

    invoke-static {}, Lcom/android/server/am/b;->obl()J
...
.method public handleAppKilledLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/am/lqr;->tsu:Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/am/lqr;->ibl:Lcom/android/server/am/i;

    invoke-virtual {v0, p1}, Lcom/android/server/am/i;->tsu(Lcom/android/server/am/ProcessRecord;)Z
    ...
    iget-object v2, p0, Lcom/android/server/am/lqr;->ibl:Lcom/android/server/am/i;

    invoke-virtual {v2, p1, v0, v1}, Lcom/android/server/am/i;->kth(Lcom/android/server/am/ProcessRecord;J)V

    iget-object p0, p0, Lcom/android/server/am/lqr;->ibl:Lcom/android/server/am/i;

    invoke-virtual {p0, p1, v0, v1}, Lcom/android/server/am/i;->cno(Lcom/android/server/am/ProcessRecord;J)V
...
.method public initAms(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/lqr;->cno:Lcom/android/server/am/ActivityManagerService;

    invoke-direct {p0}, Lcom/android/server/am/lqr;->j()V
...
.method public initPackages(Lcom/android/server/pm/PackageManagerService;Landroid/util/ArrayMap;)V
    ...
    sget-boolean v0, Lcom/android/server/am/lqr;->q:Z
    ...
    :cond_0
    sput-object p1, Lcom/android/server/am/lqr;->t:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-direct {p0, p2}, Lcom/android/server/am/lqr;->o(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)V
    ...
    sput-boolean p0, Lcom/android/server/am/lqr;->q:Z
...
.method protected irq(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr;->bio:Lcom/android/server/vdb;
...
.method public isJobRestrict(Ljava/lang/Object;)Z
    ...
    :try_start_0
    invoke-static {p0}, Lcom/android/server/am/b;->irq(Lcom/android/server/am/ugm;)Z
...
.method public isOnePixelWindow(Landroid/view/WindowManager$LayoutParams;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/lqr;->rtg:Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/am/lqr;->hmo:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr;->ugm:Lcom/android/server/am/n;

    invoke-virtual {v0, p1}, Lcom/android/server/am/n;->sis(Landroid/view/WindowManager$LayoutParams;)Z
    ...
    :cond_2
    invoke-virtual {p0, v0}, Lcom/android/server/am/lqr;->ivd(I)Z
...
.method protected l(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr;->ire:Ljava/util/List;
...
.method public reportRestrictJob(Ljava/lang/Object;J)V
    ...
    :try_start_0
    invoke-static {p0, p2, p3}, Lcom/android/server/am/b;->ivd(Lcom/android/server/am/ugm;J)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setCurrentIME(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/l;->gwm(Ljava/lang/String;)V
...
.method public setCurrentWallpaper(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/l;->ugm(Ljava/lang/String;)V
...
.method public skipBroadcast(Ljava/lang/String;ILandroid/content/Intent;)Z
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/am/lqr;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
...
.method public startJobMonitoring(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    new-instance p0, Lcom/android/server/am/gwm;

    invoke-direct {p0, p1}, Lcom/android/server/am/gwm;-><init>(Ljava/lang/Object;)V

    new-instance p1, Lcom/android/server/am/ugm;

    invoke-direct {p1, p2}, Lcom/android/server/am/ugm;-><init>(Ljava/lang/Object;)V

    :try_start_0
    invoke-static {p0, p1}, Lcom/android/server/am/b;->b(Lcom/android/server/am/gwm;Lcom/android/server/am/ugm;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public stopJobMonitoring(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :try_start_0
    invoke-static {p0, p1}, Lcom/android/server/am/b;->c(Lcom/android/server/am/gwm;Lcom/android/server/am/ugm;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public updateAccessibilityService(Ljava/util/Set;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/am/lqr;->lqr(Ljava/lang/String;)I
...
.method public updateGMSActionSet(Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/l;->obl(Ljava/util/List;)V
...
.method public updateGMSRestrict(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/l;->oxb(Z)V
...
.method public updateHighPowerUsagePackages(Ljava/util/Collection;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/lqr;->updateHighPowerUsagePackage(Ljava/lang/String;)V
...
.method public updateWidgetComponent(Landroid/content/ComponentName;Z)V
    ...
    iget-object p2, p0, Lcom/android/server/am/lqr;->ear:Ljava/util/Map;
...
.method public vdw(Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Lcom/android/server/am/l;->oif(Ljava/lang/String;)Z
