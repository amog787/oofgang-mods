...
.field private static ssp:Lcom/android/server/am/i; = null

.field protected static wtn:J = 0xea60L


# instance fields
.field private rtg:Lcom/android/server/am/i$zta;
...
.method private constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/i;->zta:Lcom/android/server/am/ActivityManagerService;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/i;->you:Ljava/util/ArrayList;

    new-instance p1, Lcom/android/internal/app/ProcessMap;

    invoke-direct {p1}, Lcom/android/internal/app/ProcessMap;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/i;->sis:Lcom/android/internal/app/ProcessMap;

    new-instance p1, Lcom/android/internal/app/ProcessMap;

    invoke-direct {p1}, Lcom/android/internal/app/ProcessMap;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/i;->tsu:Lcom/android/internal/app/ProcessMap;
...
.method private synthetic rtg(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/i;->zta:Lcom/android/server/am/ActivityManagerService;
...
.method private sis(Lcom/android/server/am/ProcessRecord;)Z
    ...
    sget v0, Lcom/android/server/am/i;->dma:I
    ...
    sget p1, Lcom/android/server/am/i;->dma:I
...
.method private you(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/i;->sis(Lcom/android/server/am/ProcessRecord;)Z
    ...
    sget-boolean v0, Lcom/android/server/am/lqr;->r:Z

    if-eqz v0, :cond_0

    sget-object v0, Lcom/android/server/am/lqr;->s:Landroid/os/Handler;

    new-instance v1, Lcom/android/server/am/ssp;

    invoke-direct {v1, p0, p1}, Lcom/android/server/am/ssp;-><init>(Lcom/android/server/am/i;Ljava/lang/String;)V
...
.method public static zta(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/i;
    .locals 1

    sget-object v0, Lcom/android/server/am/i;->ssp:Lcom/android/server/am/i;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/i;

    invoke-direct {v0, p0}, Lcom/android/server/am/i;-><init>(Lcom/android/server/am/ActivityManagerService;)V

    sput-object v0, Lcom/android/server/am/i;->ssp:Lcom/android/server/am/i;

    :cond_0
    sget-object p0, Lcom/android/server/am/i;->ssp:Lcom/android/server/am/i;
...
.method protected cno(Lcom/android/server/am/ProcessRecord;J)V
    ...
    iget-object v0, p0, Lcom/android/server/am/i;->rtg:Lcom/android/server/am/i$zta;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/i$zta;

    invoke-direct {v0, p0}, Lcom/android/server/am/i$zta;-><init>(Lcom/android/server/am/i;)V

    iput-object v0, p0, Lcom/android/server/am/i;->rtg:Lcom/android/server/am/i$zta;

    :cond_0
    iget-object v0, p0, Lcom/android/server/am/i;->rtg:Lcom/android/server/am/i$zta;

    iget-object v0, v0, Lcom/android/server/am/i$zta;->you:Ljava/lang/String;
    ...
    iget v1, v0, Lcom/android/server/am/i$zta;->sis:I
    ...
    invoke-static {v0, v1, v2, p2, p3}, Lcom/android/server/am/i$zta;->you(Lcom/android/server/am/i$zta;Ljava/lang/String;IJ)Z
    ...
    invoke-static {v0, p2, p3}, Lcom/android/server/am/i$zta;->sis(Lcom/android/server/am/i$zta;J)V

    iget-object p2, p0, Lcom/android/server/am/i;->rtg:Lcom/android/server/am/i$zta;

    invoke-static {p2}, Lcom/android/server/am/i$zta;->tsu(Lcom/android/server/am/i$zta;)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/i;->you(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)V

    goto :goto_1

    :cond_2
    :goto_0
    iget-object p0, p0, Lcom/android/server/am/i;->rtg:Lcom/android/server/am/i$zta;

    iget-object v0, p1, Lcom/android/server/am/ProcessRecord;->processName:Ljava/lang/String;

    iget p1, p1, Lcom/android/server/am/ProcessRecord;->uid:I

    invoke-static {p0, v0, p1, p2, p3}, Lcom/android/server/am/i$zta;->zta(Lcom/android/server/am/i$zta;Ljava/lang/String;IJ)V
...
.method protected kth(Lcom/android/server/am/ProcessRecord;J)V
    ...
    iget-object v0, p0, Lcom/android/server/am/i;->sis:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object v1, p0, Lcom/android/server/am/i;->tsu:Lcom/android/internal/app/ProcessMap;
    ...
    sget-wide v7, Lcom/android/server/am/i;->wtn:J
    ...
    sget v2, Lcom/android/server/am/i;->gck:I

    if-lt v0, v2, :cond_1

    iget-object p2, p0, Lcom/android/server/am/i;->sis:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object p2, p0, Lcom/android/server/am/i;->tsu:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object p0, p0, Lcom/android/server/am/i;->tsu:Lcom/android/internal/app/ProcessMap;
    ...
    sget-wide v3, Lcom/android/server/am/i;->wtn:J
...
.method public synthetic ssp(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/i;->rtg(Ljava/lang/String;)V
...
.method protected tsu(Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/am/lqr;->irq(Ljava/lang/String;)Z
    ...
    :cond_5
    iget-object v1, p0, Lcom/android/server/am/i;->you:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/i;->you:Ljava/util/ArrayList;
    ...
    sget v1, Lcom/android/server/am/i;->dma:I
