.class public Lcom/android/server/am/ear$zta;
...
.field private static you:Lcom/android/server/am/ear$zta; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/ear$zta;->sis:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/am/ear$zta;->tsu:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/am/ear$zta;->rtg:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/am/ear$zta;->ssp:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/am/ear$zta;->cno:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/am/ear$zta;->kth:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/am/ear$zta;->bio:Ljava/util/List;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/am/ear$zta;->igw:Landroid/util/ArrayMap;
...
.method private constructor <init>()V
    ...
    sget-object v1, Lcom/android/server/am/ear$zta;->igw:Landroid/util/ArrayMap;

    const-string v2, "android.intent.action.ANY_DATA_STATE"

    invoke-virtual {v1, v2, v0}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-direct {p0}, Lcom/android/server/am/ear$zta;->ssp()V
...
.method static final bio(Lcom/android/server/am/BroadcastFilter;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    invoke-static {}, Lcom/android/server/am/ear$zta;->rtg()Lcom/android/server/am/ear$zta;
    ...
    invoke-direct {v2, v3, p1, p2}, Lcom/android/server/am/ear$zta;->wtn(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-static {}, Lcom/android/server/am/ear;->sis()Z
...
.method public static cno()V
    ...
    invoke-static {v0}, Lcom/android/server/am/ear;->ywr(Ljava/lang/String;)Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/am/ear$zta;->tsu:Ljava/util/List;
...
.method public static dma(Ljava/util/List;)V
    ...
    sget-object v0, Lcom/android/server/am/ear$zta;->tsu:Ljava/util/List;
...
.method private gck(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/am/ear$zta;->igw:Landroid/util/ArrayMap;

    monitor-enter p0

    :try_start_0
    sget-object v0, Lcom/android/server/am/ear$zta;->igw:Landroid/util/ArrayMap;
...
.method static final igw(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-direct {v2, p1, p2, v3}, Lcom/android/server/am/ear$zta;->wtn(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
...
.method private kth(Ljava/util/List;)V
    ...
    sget-boolean p0, Lcom/android/server/am/ear;->ssp:Z
...
.method public static qbh(Ljava/util/List;)V
    ...
    sget-object v0, Lcom/android/server/am/ear$zta;->kth:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/ear$zta;->kth:Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/ear$zta;->kth(Ljava/util/List;)V
...
.method private static rtg()Lcom/android/server/am/ear$zta;
    .locals 1

    sget-object v0, Lcom/android/server/am/ear$zta;->you:Lcom/android/server/am/ear$zta;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/ear$zta;

    invoke-direct {v0}, Lcom/android/server/am/ear$zta;-><init>()V

    sput-object v0, Lcom/android/server/am/ear$zta;->you:Lcom/android/server/am/ear$zta;
...
.method private sis(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/am/ear$zta;->ssp:Ljava/util/ArrayList;

    monitor-enter p0

    :try_start_0
    sget-object v0, Lcom/android/server/am/ear$zta;->ssp:Ljava/util/ArrayList;
...
.method private ssp()V
    ...
    sget-object p0, Lcom/android/server/am/ear$zta;->bio:Ljava/util/List;
...
.method private tsu(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/am/ear$zta;->rtg:Ljava/util/ArrayList;

    monitor-enter p0

    :try_start_0
    sget-object v0, Lcom/android/server/am/ear$zta;->rtg:Ljava/util/ArrayList;
...
.method private wtn(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    invoke-direct {p0, v0, v4}, Lcom/android/server/am/ear$zta;->gck(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_5
    sget-object v4, Lcom/android/server/am/ear$zta;->sis:Ljava/util/List;

    monitor-enter v4

    :try_start_0
    sget-object v5, Lcom/android/server/am/ear$zta;->sis:Ljava/util/List;
    ...
    sget-object p0, Lcom/android/server/am/ear$zta;->cno:Ljava/util/ArrayList;
    ...
    :cond_c
    :goto_0
    invoke-static {}, Lcom/android/server/am/ear;->tsu()Z
    ...
    sget-object v2, Lcom/android/server/am/ear$zta;->bio:Ljava/util/List;
    ...
    :cond_e
    invoke-direct {p0, v0}, Lcom/android/server/am/ear$zta;->tsu(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/ear$zta;->sis(Ljava/lang/String;)Z
    ...
    :cond_12
    sget-object p0, Lcom/android/server/am/ear$zta;->kth:Ljava/util/List;
...
.method public static ywr(Ljava/util/List;)V
    ...
    sget-object v0, Lcom/android/server/am/ear$zta;->sis:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/ear$zta;->sis:Ljava/util/List;
...
.method static final zta(Lcom/android/server/am/BroadcastQueue;Landroid/content/pm/ResolveInfo;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-direct {v2, v1, p2}, Lcom/android/server/am/ear$zta;->you(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/BroadcastRecord;)Z
