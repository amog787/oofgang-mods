...
.field oif:Lcom/android/server/zgw;
...
.field final ssp:Lcom/android/server/obl$zta;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/obl;->bvj:Z

    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/server/obl;->oxb:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/obl;->veq:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/obl;->you:Z

    new-array v1, v0, [I

    iput-object v1, p0, Lcom/android/server/obl;->sis:[I

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/obl;->rtg:Ljava/util/List;
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/server/obl$zta;-><init>(Lcom/android/server/obl;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/android/server/obl;->ssp:Lcom/android/server/obl$zta;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/obl;->kth:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/obl;->bio:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/obl;->igw:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/server/obl;->gck:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/obl;->dma:Ljava/util/List;
...
.method private bio(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/android/server/obl;->kth:Ljava/util/HashMap;
    ...
    new-instance v3, Lcom/android/server/obl$you;

    invoke-direct {v3, v2, v1, v0}, Lcom/android/server/obl$you;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/server/obl;->kth:Ljava/util/HashMap;
...
.method private cno(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    sget-boolean v3, Lcom/android/server/obl;->bvj:Z
...
.method private gck(Lorg/json/JSONArray;)V
    ...
    iget-object p0, p0, Lcom/android/server/obl;->cno:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/android/server/obl;->cno:Ljava/util/List;
    ...
    :try_start_1
    iget-object v6, p0, Lcom/android/server/obl;->cno:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/server/obl;->cno:Ljava/util/List;
    ...
    sget-object v6, Lcom/android/server/obl;->veq:Ljava/util/List;
    ...
    :try_start_3
    sget-object v7, Lcom/android/server/obl;->veq:Ljava/util/List;
    ...
    sget-object v8, Lcom/android/server/obl;->veq:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/obl;->igw:Ljava/util/List;
    ...
    :try_start_5
    iget-object v7, p0, Lcom/android/server/obl;->igw:Ljava/util/List;
    ...
    sget-boolean v8, Lcom/android/server/obl;->bvj:Z
    ...
    :cond_5
    iget-object v8, p0, Lcom/android/server/obl;->igw:Ljava/util/List;
    ...
    :cond_6
    iget-object v4, p0, Lcom/android/server/obl;->bio:Ljava/util/HashMap;

    iget-object v7, p0, Lcom/android/server/obl;->igw:Ljava/util/List;

    invoke-direct {p0, v4, v7, v0}, Lcom/android/server/obl;->cno(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v6, p0, Lcom/android/server/obl;->dma:Ljava/util/List;
    ...
    :try_start_7
    iget-object v7, p0, Lcom/android/server/obl;->dma:Ljava/util/List;
    ...
    :cond_8
    iget-object v8, p0, Lcom/android/server/obl;->dma:Ljava/util/List;
    ...
    :cond_9
    iget-object v4, p0, Lcom/android/server/obl;->gck:Ljava/util/HashMap;

    iget-object v7, p0, Lcom/android/server/obl;->dma:Ljava/util/List;

    invoke-direct {p0, v4, v7, v5}, Lcom/android/server/obl;->cno(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v4, p0, Lcom/android/server/obl;->rtg:Ljava/util/List;
    ...
    :try_start_9
    iget-object v5, p0, Lcom/android/server/obl;->rtg:Ljava/util/List;
    ...
    sget-boolean v6, Lcom/android/server/obl;->bvj:Z
    ...
    :cond_b
    iget-object v6, p0, Lcom/android/server/obl;->rtg:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/obl;->cno:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/obl;->veq:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/obl;->rtg:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/server/obl;->cno:Ljava/util/List;

    invoke-direct {p0, p1}, Lcom/android/server/obl;->bio(Ljava/util/List;)V
    :try_end_a
...
.method private kth()V
    ...
    iget-object p0, p0, Lcom/android/server/obl;->rtg:Ljava/util/List;
...
.method private ssp(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    :cond_2
    sget-boolean p0, Lcom/android/server/obl;->bvj:Z
...
.method private wtn(Ljava/lang/String;Landroid/app/PendingIntent;I)J
    ...
    iget-object p0, p0, Lcom/android/server/obl;->kth:Ljava/util/HashMap;
    ...
    check-cast p3, Lcom/android/server/obl$you;

    if-eqz p3, :cond_1

    iget-object v0, p3, Lcom/android/server/obl$you;->sis:Ljava/lang/String;
    ...
    :cond_0
    iget-wide p0, p3, Lcom/android/server/obl$you;->you:J
...
.method static synthetic you(Lcom/android/server/obl;)Landroid/content/Context;
    .locals 0
...
.method static synthetic zta(Lcom/android/server/obl;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/obl;->gck(Lorg/json/JSONArray;)V
...
.method public alleviateFirePendingLocked(Ljava/util/ArrayList;)Z
    ...
    iget-object v1, v0, Lcom/android/server/obl;->ywr:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_3
    iget-object v4, v0, Lcom/android/server/obl;->ywr:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v4, v0, Lcom/android/server/obl;->oif:Lcom/android/server/zgw;
    ...
    check-cast v4, Lcom/android/server/zgw;

    iput-object v4, v0, Lcom/android/server/obl;->oif:Lcom/android/server/zgw;
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/zgw;->rtg(Ljava/lang/String;)Z
    ...
    invoke-static {v5, v6}, Lcom/android/server/obl;->sis(J)J
    ...
    iget-object v5, v0, Lcom/android/server/obl;->ywr:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :goto_9
    sget-boolean v5, Lcom/android/server/obl;->bvj:Z
...
.method public dumpNextWakeFromIdleInfo()V
    ...
    sget-object p0, Lcom/android/server/obl;->obl:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v0, Lcom/android/server/obl;->obl:Lcom/android/server/AlarmManagerService;
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/obl;->bvj:Z
    ...
    sget-object v5, Lcom/android/server/obl;->obl:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v4, Lcom/android/server/obl;->obl:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v3, Lcom/android/server/obl;->obl:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v2, Lcom/android/server/obl;->obl:Lcom/android/server/AlarmManagerService;
...
.method public ifDropPkgAlarm(Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    ...
    iget-object v0, p0, Lcom/android/server/obl;->bio:Ljava/util/HashMap;

    const/4 v1, 0x0

    invoke-direct {p0, v0, p1, v1, p2}, Lcom/android/server/obl;->ssp(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    iget-object v0, p0, Lcom/android/server/obl;->gck:Ljava/util/HashMap;

    invoke-direct {p0, v0, p1, v2, p2}, Lcom/android/server/obl;->ssp(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
...
.method public ifEnableLogDump()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/obl;->you:Z
...
.method public ifHandleCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    sget-boolean v4, Lcom/android/server/obl;->bvj:Z

    if-ne v4, v3, :cond_2

    iget-object p2, p0, Lcom/android/server/obl;->bio:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v0}, Lcom/android/server/obl;->rtg(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V

    iget-object p2, p0, Lcom/android/server/obl;->gck:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v3}, Lcom/android/server/obl;->rtg(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/android/server/obl;->tsu(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
...
.method public ifNeedPending(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    sget-boolean v0, Lcom/android/server/obl;->oxb:Z
    ...
    iget-object v0, p0, Lcom/android/server/obl;->oif:Lcom/android/server/zgw;
    ...
    iput-object v0, p0, Lcom/android/server/obl;->oif:Lcom/android/server/zgw;
    ...
    :cond_1
    invoke-virtual {v0, p1}, Lcom/android/server/zgw;->gck(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/obl;->igw(Ljava/lang/String;)Z
...
.method public igw(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/obl;->veq:Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    sget-object v2, Lcom/android/server/obl;->veq:Ljava/util/List;
...
.method public initInstance(Lcom/android/server/AlarmManagerService;Landroid/content/Context;)V
    ...
    :cond_0
    sput-object p1, Lcom/android/server/obl;->obl:Lcom/android/server/AlarmManagerService;

    iput-object p2, p0, Lcom/android/server/obl;->zta:Landroid/content/Context;
...
.method public modifyMinTrigger(JJJILandroid/app/PendingIntent;ILjava/lang/String;J)[J
    ...
    invoke-direct {p0, v0, p8, p7}, Lcom/android/server/obl;->wtn(Ljava/lang/String;Landroid/app/PendingIntent;I)J
...
.method public onStart(Lcom/android/server/AlarmManagerService$AmsInner;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/obl;->ywr:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v2, p0, Lcom/android/server/obl;->gck:Ljava/util/HashMap;

    invoke-direct {p0, v2, v0, p1}, Lcom/android/server/obl;->cno(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iput-object p1, p0, Lcom/android/server/obl;->cno:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/obl;->cno:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/obl;->ssp:Lcom/android/server/obl$zta;

    new-instance v2, Lcom/android/server/obl$sis;

    invoke-direct {v2, p0}, Lcom/android/server/obl$sis;-><init>(Lcom/android/server/obl;)V
    ...
    iput-object p1, p0, Lcom/android/server/obl;->qbh:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object p1, p0, Lcom/android/server/obl;->tsu:Ljava/util/List;

    invoke-direct {p0}, Lcom/android/server/obl;->kth()V

    sget-object p1, Lcom/android/server/obl;->veq:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/obl;->ssp:Lcom/android/server/obl$zta;
...
.method public setDeepSleepMode(Z)V
    ...
    :cond_0
    sput-boolean p1, Lcom/android/server/obl;->oxb:Z
...
.method public setDeepSleepWhitelist([I)V
    ...
    iput-object p1, p0, Lcom/android/server/obl;->sis:[I
...
.method protected tsu(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
    ...
    iput-boolean p1, p0, Lcom/android/server/obl;->you:Z

    if-eqz v0, :cond_3

    :goto_0
    invoke-virtual {v0, p1}, Lcom/android/server/zgw;->bio(Z)Z
...
.method public updateFlag(Ljava/lang/String;ILandroid/app/AlarmManager$AlarmClockInfo;Ljava/lang/String;)I
    ...
    iget-object p3, p0, Lcom/android/server/obl;->tsu:Ljava/util/List;
